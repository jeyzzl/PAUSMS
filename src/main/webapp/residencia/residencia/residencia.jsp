...
<%	
	...
	String acomodoId 			= (String) request.getAttribute("acomodoId");
	String recogidaId 			= (String) request.getAttribute("recogidaId");
...
<%	//  Se muestra al inicio y cuando se cambia un alumno a Externo ..� 
    ...
    <tr> 
    	<td width="10%"><strong>Street:</strong></td>
      	<td width="43%">         
        	<input name="Calle" type="text" class="form-control" id="Calle" value="<%=dato.getCalle()%>" style="width:25rem;" maxlength="30">        
      	</td>
      	<td width="20%"><strong>Tel. Area:</strong></td>
      	<td width="27%"> 
        	<input name="Area" type="text" class="form-control" id="Area" value="<%=dato.getTelArea()%>" style="width:25rem;" maxlength="7">
      	</td>
    </tr>
	<tr> 
		<td height="21"><strong>House #:</strong></td>
	    <td> 
	       	<input name="Numero" type="text" class="form-control" id="Numero" value="<%=dato.getNumero()%>" style="width:25rem;" maxlength="14">
	    </td>
	    <td><strong>Phone:</strong></td>
	    <td> 
	       	<input name="Telefono" type="text" class="form-control" id="Telefono" value="<%=dato.getTelNum()%>" style="width:25rem;" maxlength="12">
	    </td>
	</tr>
	<tr> 
		<td><strong>Neighborhood:</strong></td>
	    <td> 
	    	<input name="Colonia" type="text" class="form-control" id="Colonia" value="<%=dato.getColonia()%>" style="width:25rem;" maxlength="20">
	    </td>
	    <td><strong>Mentor Name:</strong></td>
	    <td>
	    	<input name="Nombre" type="text" class="form-control" id="Nombre" value="<%=dato.getNombreTut()%>" style="width:25rem;" maxlength="20">
	    </td>
	</tr>
	<tr> 
		<td><strong>Village/Town:</strong></td>
	    <td> 
	    	<input name="Municipio" type="text" class="form-control" id="Municipio" value="<%=dato.getMpio()%>" style="width:25rem;" maxlength="20">
	    </td>
	    <td><strong>Mentor Surname: </strong></td>
	    <td> 
	    	<input name="Apellidos" type="text" class="form-control" id="Apellidos" value="<%=dato.getApellidoTut()%>" style="width:25rem;" maxlength="20">
	    </td>
	</tr>
	<tr> 
		<td height="22"><strong>Reason:</strong></td>
	    <td> 
	    	<select name="Razon" class="form-select" style="width:25rem;">
...
<%	
	...
	<tr> 
	    ...
	    <td><input name="Fecha" type="text" class="form-control" id="Fecha" data-date-format="dd/mm/yyyy" value="<%=fecha%>" style="width:25rem;" maxlength="10"><strong> (DD/MM/YYYY)</strong></td>
	    <td><strong>Res. History: </strong></td>
	    <td><input name="Comentario" type="text" class="form-control" size="30" maxlength="70" value="<%=resComentario.getComentario()%>" readonly></td>
	</tr>
	<tr> 
		<td height="22"><strong>Accommodation Type:</strong></td>
	    <td> 
	    	<select name="Acomodo" class="form-select" style="width:25rem;">
			
<%	
		for(CatAcomodo acomodo : lisAcomodos){
%>
			<option <%=acomodo.getAcomodoId().equals(acomodoId)?"selected":""%> value="<%=acomodo.getAcomodoId()%>"><%=acomodo.getNombreCorto()%>-<%=acomodo.getNombre()%></option>
<%
		}
%>
	        </select>       
	    </td>	 
		<td height="22"><strong>Pick up location:</strong></td>       
		<td>
	    	<select name="Recogida" class="form-select" style="width:25rem;">
				<option <%=recogidaId.equals("0")?"selected":""%> value="0">None</option>
<%	
		for(CatRecogida recogida : lisRecogidas){
%>
				<option <%=recogida.getRecogidaId().equals(recogidaId)?"selected":""%> value="<%=recogida.getRecogidaId()%>"><%=recogida.getNombreCorto()%>-<%=recogida.getNombre()%></option>
<%
		}
%>
	        </select>  
	...
	<tr>
	    ...
	    <td><input name="ComentarioB" type="text" class="form-control" size="30" maxlength="70" value="<%=resComentario.getComentarioB()%>" style="width:25rem;"></td>
		<td></td>
		<td></td>
	</tr>
	<tr>
...
%>
	...
	<table class="table table-condensed">
		...
		<tr>
			...
			<td>
				<select name="Requerido" class="form-select" style="width:20rem;">       	
		...
		<tr>
			...
			<td>
				<select name="Dormitorio" id="Dormitorio" class="form-select" style="width:20rem;">
<%
...
%>
		...
		<tr>
			<td>
				<strong>Res. Hist:</strong>
			</td>
			<td>
				<input name="Comentario" type="text" class="form-control" style="width:30rem;" maxlength="70" value="<%=resComentario.getComentario()%>" readonly>        
			</td>
  		</tr>
		<tr>
			<td>
			...
			<td>
				<select name="Acomodo" id="Acomodo" class="form-select" style="width:20rem;">
<%	
		for(CatAcomodo acomodo : lisAcomodos){
%>
			<option <%=acomodo.getAcomodoId().equals(acomodoId)?"selected":""%> value="<%=acomodo.getAcomodoId()%>"><%=acomodo.getNombreCorto()%>-<%=acomodo.getNombre()%></option>
...
%>
		...
		<tr>
			...
			<td>
				<input name="ComentarioB" type="text" class="form-control" style="width:30rem;" maxlength="70" value="<%=resComentario.getComentarioB()%>">        
			</td>
		</tr>
		<tr>  
			<th>
