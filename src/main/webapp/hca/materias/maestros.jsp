...
<%
	String codigoEmpleado	= (String) request.getParameter("codigoEmpleado")==null?"0":request.getParameter("codigoEmpleado");
	String facultad 		= request.getParameter("FacultadId")==null?"0":request.getParameter("FacultadId");
	String empleadoNombre	= (String)request.getParameter("empleadoNombre")==null?"-":request.getParameter("empleadoNombre"); 
	String facultadNombre	= (String)request.getParameter("facultadNombre")==null?"-":request.getParameter("facultadNombre");	
	String carreraId		= "X";	
	int cont=0;
...
<div class="container-fluid">
	...
	<div class="alert alert-success  d-flex align-items-center">
		<b>Empleado:</b> [<b><%=codigoEmpleado%></b>] <b><%=empleadoNombre %></b>
