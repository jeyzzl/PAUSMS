...
<div class="container-fluid">
	...
	<div class="form-group">
		...
		<select class="form-select mb-2" name="TipoPatrocinador" id="TipoPatrocinador">
			<option value="C" <%=patrocinador.getTipo().equals("C")?"selected":""%>>Corporate</option>
			<option value="N" <%=patrocinador.getTipo().equals("N")?"selected":""%>>Non-Corporate</option>
		</select>
	</div>
	<div class="alert alert-info">
