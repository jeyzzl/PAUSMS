...
<div class="container-fluid">
	...
	<h1>Backup General Documents</h1>
	...
	(function($){
		...
		$('.crear-respaldo').on('click', function(e){
			...
			*/
			...
			$.get('zipGeneral?fechaIni='+fInicio.val()+'&fechaFin='+fFin.val(), function(r){
		...
		$('.eliminar-respaldo').on('click', function(e){
			...
			$.get('deleteZipGeneral', function(r){
