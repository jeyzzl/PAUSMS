...
<%
	...
	try{
		 ...
		 COMANDO = "select count(*) as total from PORTAL.ARCHIVOS_PROFESOR where fecha >= to_date('"+fechaIni+"', 'DD/MM/YYYY') and fecha <= to_date('"+fechaFin+"', 'DD/MM/YYYY')"; 
		 ...
		 COMANDO = "SELECT * FROM PORTAL.ARCHIVOS_PROFESOR"+
	...
	try{ 
		...
		String zipFile = dir+"resArchProf.zip";
		...
		while (rset2.next()){
			...
			//System.out.println("Datos:"+nombreArchivo);
	...
	if(error){
		...
		new File(dir+"resArchProf.zip").delete();
	}
