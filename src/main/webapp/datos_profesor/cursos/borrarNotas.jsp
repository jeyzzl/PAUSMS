...
<jsp:useBean id="BorraNotasUtil" scope="page" class="aca.carga.CargaGrupoBorraUtil"/>
	...
	switch (numAccion){
		case 4: {// Borrar Notas de la materia
			...
			if (bolActReg && bolAct && bolEst && bolEstReg){
				...
				folio = BorraNotasUtil.maximoReg(conEnoc, cursoCargaId);
				...
				if ( BorraNotasUtil.insertReg(conEnoc, BorraNotas) ){	
					conEnoc.commit();
					bolDelete = true;					
					BorraNotas = BorraNotasUtil.mapeaRegId(conEnoc,cursoCargaId,folio);
...
<h1>Borrar Notas</h1>
<div class='well'>
	<a href="cursos" class="btn btn-primary">Regresar</a>
</div>
<table class="table table-fullcondensed" align="CENTER">
<tr>
  <td align="center" style="font-size:11pt; text-align:center">
...
<tr>
	<td align="center" style="font-size:10pt; text-align:center">
  		<b>Acta:</b> [ <%=cursoCargaId%> ] - <b>Materia:</b> <%=nombreMateria%>
	</td>
</tr>
<tr>
	<td align="center" style="font-size:10pt; text-align:center">
  		<b>Maestro:</b> <%=nombreMaestro%>
	</td>
</tr>
</table>
...
<table style="margin: 0 auto;">
  <tr>    
	<td align="center">
<% 	if ( numEst > 0 ){%>
	  <input name="Borrar Notas" onClick="javascript:Borrar()" type="button" value="Borrar Notas" ></td>
<% 	}else{
