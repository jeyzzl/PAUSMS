...
<% 
	...
	try{		
		File carpeta = new File(application.getRealPath("/WEB-INF/pdf/diferida/"));
	...
	// Cambia la diagonal inversa por la diagonal normal para que se pueda ver el archivo en windows (localhost)
