...
<div class="container-fluid">
	<h2>Assessment Scheme <small class="text-muted fs-6">( <%=cursoCargaId%> - <%=materiaNombre%> - <%=maestroNombre%> )</small></h2>
	<div class="alert alert-info">
		<a class="btn btn-primary" href="cursos"><i class="fas fa-arrow-left"></i></a>&nbsp;&nbsp;&nbsp;
	</div>	
	<div class="alert alert-info">
		<h4>Number of Students: <span class='badge badge bg-dark'><%=numAlumnos%></span> &nbsp; &nbsp; Graded Points: <span class='badge badge bg-dark'><%=avanceMateria%></span></h4>	
	</div>
	<br>
	...
	<tr>
		...
		<th width="10%" class="right"><h4>#Assesments.</h4></th>
		<th width="10%" class="right"><h4>#Grades</h4></th>
		<th width="10%" class="right"><h4>Weight(%)</h4></th>
		<th width="10%" class="right"><h4>Progress/Pts</h4></th>
		<th width="10%" class="right"><h4>Progress(%)</h4></th>
	</tr>								
<%	int row = 0;
...
%>	
		<tr class="alert alert-success">
	    	...
	    	<td class="right"><h4><span class='badge bg-secondary'><%=getFormato.format(Double.parseDouble(avanceEvaluaciones))%></span></h4></td>
