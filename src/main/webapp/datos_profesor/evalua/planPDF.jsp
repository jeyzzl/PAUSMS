...
<%
	String cursoCargaId = (String) session.getAttribute("CursoCargaId")==null?request.getParameter("CursoCargaId"):(String) session.getAttribute("CursoCargaId"); 
	String maestro 	    = (String) session.getAttribute("Maestro")==null?request.getParameter("Maestro"):(String) session.getAttribute("Maestro");
	String materia 	    = (String) session.getAttribute("Materia")==null?request.getParameter("Materia"):(String) session.getAttribute("Materia");
	...
	ArrayList lisEjes   		= EjeU.getListEjes(conEnoc, cursoCargaId, "ORDER BY EJE_ID");
	ArrayList lisComp  			= CompU.getListCompetencias(conEnoc, cursoCargaId, "ORDER BY COMPETENCIA_ID");
	...
	ArrayList listEvaluaciones 	= PlanEvalU.getListEvaluaciones(conEnoc, cursoCargaId, "ORDER BY EVALUACION_ID");
	ArrayList listBiblio 		= BiblioU.getListBiblio(conEnoc, cursoCargaId, " ORDER BY ORDEN");
	...
	File fileCarpeta = new File(application.getRealPath("/WEB-INF/pdf/planCurso/"));
	...
	try{		
        ...
        document.addSubject("Plan de Curso"+codigoAlumno);
    ...
    //Logo Um y texto debajo
		...
		celda = new PdfPCell(new Phrase("Competencia del Perfil"
				, FontFactory.getFont(FontFactory.HELVETICA, 11, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.RECTANGLE);
