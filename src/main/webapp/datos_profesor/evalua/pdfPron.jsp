...
<%	
	...
	File fileCarpeta = new File(application.getRealPath("/WEB-INF/pdf/prontuario/"));
	...
	try{
		...
		document.addAuthor("Gestión Academica");
        document.addSubject("Plan de curso "+cursoCargaId);        
    ...
    //Logo Um y texto debajo
		...
		//Encabezado	
	 	...
	 	Phrase uni = new Phrase( "UNIVERSIDAD DE MONTEMORELOS", FontFactory.getFont(FontFactory.HELVETICA, 16, Font.BOLD, new BaseColor(0,0,0)) );   	
   		ColumnText.showTextAligned(canvas, Element.ALIGN_CENTER, uni, posX+360, posY+730, 0);
	    	
    	Phrase facultad = new Phrase( "Facultad de "+nombreFacultad, FontFactory.getFont(FontFactory.HELVETICA, 14, Font.BOLD, new BaseColor(0,0,0)) );   	
    	...
    	Phrase plan = new Phrase( "Plan de curso de "+materia, FontFactory.getFont(FontFactory.HELVETICA, 12, Font.BOLD, new BaseColor(0,0,0)) );   	
    	ColumnText.showTextAligned(canvas, Element.ALIGN_CENTER, plan, posX+360, posY+640, 0);	

    	Phrase curso = new Phrase( "Curso Escolar ", FontFactory.getFont(FontFactory.HELVETICA, 12, Font.BOLD, new BaseColor(0,0,0)) );   	
    	ColumnText.showTextAligned(canvas, Element.ALIGN_CENTER, curso, posX+360, posY+625, 0);	

    	Phrase planEstudios = new Phrase( "PLAN DE ESTUDIOS ", FontFactory.getFont(FontFactory.HELVETICA, 12, Font.BOLD, new BaseColor(0,0,0)) );   	
    	ColumnText.showTextAligned(canvas, Element.ALIGN_CENTER, planEstudios, posX+360, posY+600, 0);	
	 	
    	
    	Phrase textIma1 = new Phrase( "Creada por el Gobierno", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(0,0,0)));   	
	...
	//Primera Tabla
		...
		//Primera fila
		String nombreCiclo = "";
		if (!catCarrera.getFacultadId().equals("107")) nombreCiclo = "Semestre "; else nombreCiclo = "Tetramestre ";
		
		celda = new PdfPCell(new Phrase("Ubicación:", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		...
		celda = new PdfPCell(new Phrase("Clave:", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.BOX);
		celda.setBorderWidth(0.5f);
		celda.setBackgroundColor(new BaseColor(230,230,230));
		...
		celda = new PdfPCell(new Phrase("Seriación: ", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.BOX);
		celda.setBorderWidth(0.5f);
		celda.setBackgroundColor(new BaseColor(230,230,230));
		...
		celda = new PdfPCell(new Phrase("Créditos: "+mapaCurso.getCreditos(), FontFactory.getFont(FontFactory.HELVETICA, 9, Font.NORMAL, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.BOX);
		celda.setBorderWidth(0.5f);
		celda.setBackgroundColor(new BaseColor(230,230,230));
		...
		//Tercera fila		
		celda = new PdfPCell(new Phrase("Competencia(s) que atiende la asignatura: ", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.BOX);
		celda.setBorderWidth(0.5f);
		celda.setBackgroundColor(new BaseColor(230,230,230));
		...
		celda = new PdfPCell(new Phrase("Productos de aprendizaje: ", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.BOX);
		celda.setBorderWidth(0.5f);
		celda.setBackgroundColor(new BaseColor(230,230,230));
		...
		celda = new PdfPCell(new Phrase("Proyecto integrador: ", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.BOX);
		celda.setBorderWidth(0.5f);
		celda.setBackgroundColor(new BaseColor(230,230,230));
		...
		celda = new PdfPCell(new Phrase("Horario de clases: "+pronMateria.getHoraClase(), FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.BOX);
		celda.setBorderWidth(0.5f);
		celda.setBackgroundColor(new BaseColor(230,230,230));
		...
		celda = new PdfPCell(new Phrase("Lugar: "+pronMateria.getLugar(), FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.BOX);
		celda.setBorderWidth(0.5f);
		celda.setBackgroundColor(new BaseColor(230,230,230));
		...
		celda = new PdfPCell(new Phrase("Docente: "+nombreMaestro, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.BOX);
		celda.setBorderWidth(0.5f);
		celda.setBackgroundColor(new BaseColor(230,230,230));
		...
		celda = new PdfPCell(new Phrase("Formación académica:", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.BOX);
		celda.setBorderWidth(0.5f);
		celda.setBackgroundColor(new BaseColor(230,230,230));
		...
		celda = new PdfPCell(new Phrase("Horario de tutoría: ", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.BOX);
		celda.setBorderWidth(0.5f);
		celda.setBackgroundColor(new BaseColor(230,230,230));
		...
		celda = new PdfPCell(new Phrase("Correo electrónico: ", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.BOX);
		celda.setBorderWidth(0.5f);
		celda.setBackgroundColor(new BaseColor(230,230,230));
		...
		celda = new PdfPCell(new Phrase("HFD = Horas Frente a Docente ", FontFactory.getFont(FontFactory.HELVETICA, 5, Font.NORMAL, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		celda.setColspan(2);
		tabla1.addCell(celda);
		
		celda = new PdfPCell(new Phrase("HEI = Horas Fde Estudio Independiente ", FontFactory.getFont(FontFactory.HELVETICA, 5, Font.NORMAL, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		celda.setColspan(2);
		tabla1.addCell(celda);

		celda = new PdfPCell(new Phrase("THS = Total de Horas Semanales ", FontFactory.getFont(FontFactory.HELVETICA, 5, Font.NORMAL, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		celda.setColspan(2);
		tabla1.addCell(celda);
	...
	//Segunda Tabla
		...
		parrafo.add(new Phrase("DESCRIPCIÓN DEL CURSO ", FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD, new BaseColor(r,g,b))));
		...
		parrafo1.add(new Phrase("PERSPECTIVA Y ENFOQUE DEL CURSO ", FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD, new BaseColor(r,g,b))));
		...
		parrafo3.add(new Phrase("ORGANIZACIÓN DEL APRENDIZAJE", FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD, new BaseColor(r,g,b))));
	...
	//Ciclo tablas unidades
		...
		for(aca.plan.spring.MapaNuevoUnidad unidad : unidades){
			...
			celda = new PdfPCell(new Phrase("Productos de aprendizaje:"+productos, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_LEFT);
			celda.setBorder(Rectangle.BOX);
			celda.setBorderWidth(0.5f);
			celda.setColspan(4);
			...
			celda = new PdfPCell(new Phrase("Aporte y proyecto integrador: "+aporte, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_LEFT);
			celda.setBorder(Rectangle.BOX);
			celda.setBorderWidth(0.5f);
			celda.setColspan(4);
			...
			celda = new PdfPCell(new Phrase("Semana y fecha", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_LEFT);
			celda.setBorder(Rectangle.BOX);
			celda.setBorderWidth(0.5f);
			celda.setColspan(0);
			...
			celda = new PdfPCell(new Phrase("Contenido", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_LEFT);
			celda.setBorder(Rectangle.BOX);
			celda.setBorderWidth(0.5f);
			celda.setColspan(0);
			...
			celda = new PdfPCell(new Phrase("Actividades de aprendizaje", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_LEFT);
			celda.setBorder(Rectangle.BOX);
			celda.setBorderWidth(0.5f);
			celda.setColspan(0);
			...
			celda = new PdfPCell(new Phrase("Evidencias de aprendizaje", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_LEFT);
			celda.setBorder(Rectangle.BOX);
			celda.setBorderWidth(0.5f);
			celda.setColspan(0);
			...
			for(aca.pron.spring.PronSemana semana : semanasUnidad){
				...
				if(semana.getUnidadId().equals(unidad.getUnidadId())){
					...
					celda = new PdfPCell(new Phrase(semana.getSemanaId()+" "+semana.getSemanaNombre(), FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
					celda.setHorizontalAlignment(Element.ALIGN_LEFT);
					celda.setBorder(Rectangle.BOX);
					celda.setBorderWidth(0.5f);
					celda.setColspan(0);
	...
	//Tabla Ejes
		...
		tablaEjes.setWidths(tablaValoresWidths);
		tablaEjes.setSpacingBefore(20f);
		tablaEjes.setWidthPercentage(80f);
		...
		parrafoEsquema.add(new Phrase("PAUTAS PARA LA EVALUACIÓN", FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD, new BaseColor(r,g,b))));
		...
		celda = new PdfPCell(new Phrase("Calificación Final", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.BOX);
		celda.setBorderWidth(0.5f);
		celda.setBackgroundColor(new BaseColor(230,230,230));
		...
		parrafoBiblio.add(new Phrase("BIBLIOGRAFÍA", FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD, new BaseColor(r,g,b))));
