...
public class CredencialAlumno extends Applet
{
	...
	public void start(){
        ...
        ArrayList lineas = separarCarrera(carrera, 28);
        ...
        gsN.drawString("Esta credencial es porpiedad de la",610,160);
    ...
    public ArrayList separarCarrera (String s, int ancho){
    	ArrayList lineas = new ArrayList();
    	char car;
    	int fin,inicio=0,nlineas=1,tmp;
    	if (s.length()>ancho){
    		fin = ancho-1;
    		while (fin>inicio){
    			if (fin > s.length()){ 
