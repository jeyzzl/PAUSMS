...
<div class="container-fluid">
	...
	<div class="alert alert-info">
		<a href="semejantes?Accion=0"  class="me-4" title="Search Student"><i class="fas fa-search fa-lg"></i></a>
		<a href="alumno" class="me-4" title="Personal Data"><i class="fas fa-user fa-lg"></i></a>
		<a href="accion_u" class="me-4" title="Provenance Data"><i class="fas fa-globe fa-lg"></i></a>
		<a href="accion_a" class="me-4" title="Academic Data"><i class="fas fa-book fa-lg"></i></a>
		<a href="accion_e" class="me-4" title="Background Data"><i class="fas fa-file-signature fa-lg"></i></a>
		<a href="accion_o" class="me-4" title="Bank Data"><i class="fas fa-credit-card fa-lg"></i></a>
	</div>
...
%>
		...
		<tr>
	    	<td>
				<strong>
			<%	if(institucion.equals("Sonoma")) out.print("Residence");%>
			<% 	if(institucion.equals("Pacific Adventist University") || institucion.equals("Fulton") ) out.print("Home");%> 
				Country
				</strong>
			</td>
	        <td>
...
%>
		...
		<tr>
	    	<td>
				<strong>
			<%	if(institucion.equals("Sonoma")) out.print("Residence District");%>
			<% 	if(institucion.equals("Pacific Adventist University") || institucion.equals("Fulton") ) out.print("Home Village");%>  
				</strong>
			</td>
	        <td>
	<%			
...
%>
		...
		<tr>
	  	...
	  	<tr> 
	        ...
	        <td>
				...
				<% }else{ 
					out.print(alumPersonal.getNombre());%>
	...
	<%
		...
		<tr> 
	    	<td>
				<strong>
			<%	if(institucion.equals("Sonoma")) out.print("Middle");%>
			<% 	if(institucion.equals("Pacific Adventist University") || institucion.equals("Fulton") ) out.print("Maiden");%> 
				Name
				</strong>
			</td>
	        <td>
	...
	<%		
	 	...
	 	<tr> 
			...
			<td>
				<strong>
			<%	if(institucion.equals("Sonoma")) out.print("Origin");%>
			<%-- <% 	if(institucion.equals("Pacific Adventist University") || institucion.equals("Fulton") ) out.print("Home");%>  --%>
					Country
				</strong>
			</td>
	...
	<%        	
		...
		<tr>
			...
			<td>
				<strong>
			<%	if(institucion.equals("Sonoma")) out.print("Origin Province");%>
			<% 	if(institucion.equals("Pacific Adventist University") || institucion.equals("Fulton") ) out.print("Province/State");%> 
				</strong>
			</td>
	        <td>  
	<%			  	
	...
	%>
			...
			<td>
				<strong>
			<%	if(institucion.equals("Sonoma")) out.print("Origin District");%>
			<% 	if(institucion.equals("Pacific Adventist University") || institucion.equals("Fulton") ) out.print("Village/City");%> 
				</strong>
			</td>
	        <td>		 
	<%			
		...
		<tr>
			...
			<td>
				<select name="Sync" id="Sync">
					<option value="S" <%=alumPersonal.getSync().equals("S")?"selected":""%>>Yes</option>
					<option value="N" <%=alumPersonal.getSync().equals("N")?"selected":""%>>No</option>
				</select>
			</td>
		<tr>
	</table>
