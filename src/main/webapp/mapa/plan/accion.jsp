...
<%-- 			<input name="ClaveProfesiones" type="hidden" class="text form-control" style="width:300px;" id="ClaveProfesiones" value="<%=plan.getClaveProfesiones()%>" size="30" maxlength="40" readonly> --%>
			...
			<input name="NotaExtra" type="text" class="text form-control" style="width:150px;" id="NotaExtra" value="<%=plan.getNotaExtra()%>" size="3" maxlength="2">
		</div>
		<div class="span4 col">
<%-- 			<label for=""><strong>Start <spring:message code='aca.RVOE'/></strong></label> --%>
<%-- 			<input name="RvoeInicial" type="hidden" class="text form-control" style="width:300px;" id="RvoeInicial" value="<%=plan.getRvoeInicial()%>" size="30" maxlength="60"> --%>
			<%-- <br> --%>
...
<%--           	<option value='A' <%=plan.getOficial().equals("A") ? "Selected" : "" %>>CIMUM ALLENDE</option> --%>
			...
			<label for="Descuento"><strong>Discount Percentage</strong></label>
			<input name="Descuento" type="text" class="text form-control" style="width:300px;" id="Descuento" value="<%=plan.getDescuento()%>">
		</div>
		<div class="span4 col">
...
<%-- 			<input name="FInicio" type="hidden" class="text form-control" style="width:300px;" id="FInicio" value="<%=plan.getFInicio()==null?"":plan.getFInicio()%>" onChange="validaFecha(this.value); this.value=borrar" size="10" maxlength="10"> --%>
	        <br>
