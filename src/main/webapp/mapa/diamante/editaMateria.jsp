...
<div class="container-fluid">
	<h2><spring:message code="aca.Editar"/><spring:message code="aca.Materia"/></h2>
...
%>	
	...
	<table style="border: dotted 1px gray;">
		<tr>
...
%>
		...
		<tr>
			<td><b><spring:message code="aca.Asignatura"/><font color="#AE2113"> *</font></b></td>
			<td>
<%
	if(esAdmin){
%>
...
%>
		...
		<tr>
			<td><b><spring:message code="aca.Semestre"/></b></td>
			<td>
<%
	if(esAdmin){
%>
...
%>
		...
		<tr>
			<td><b>Productos de aprendizaje</b></td>
			<td>
