...
<body>
	...
	<h3>Edit subject<small>( <%=mapaNuevoPlan.getNombre() %> - <%=mapaNuevoCurso.getNombre() %> )</small></h3>
	<div class="alert alert-info">
		<a href="materias?planId=<%=planId %>&versionId=<%=versionId %>" class="btn btn-primary">Back</a>
	</div>		
	<table class="table table-condensed" style="border: solid 1px black;" border="1">
		...
		<tr>
			<td colspan="6"><b>COMPETENCE OF THE PROFILE ATTENDING THE SUBJECT:</b></td>
			<td colspan="8"><%=mapaNuevoCurso.getCompetencia().replaceAll("\n","<br>").replaceAll(" ","&nbsp;") %></td>
		</tr>
		<tr>
			<td width="250px"><b>LEARNING PRODUCTS<small> (OBJECTIVE OF THE SUBJECT):</small></b></td>
			<td width="600px">
<% 		
...
<% 			 }%>			  
		...
		<tr>
			<td width="250px"><b>CURRICULAR LINE:</b></td>
...
%>
		...
		<tr>
			<td width="250px"><b>PROJECT INTEGRATOR TO WHICH THE SUBJECT IS LINKED</b></td>
			<td width="600px" >
				<a href="cursoAccion?planId=<%=planId%>&versionId=<%=versionId%>&cursoId=<%=cursoId%>" class="btn btn-primary btn-sm">
				  <i class='icon-pencil icon-white'></i>
				</a>				
...
%>		
		...
		<table style="border: solid 1px black;  table-layout: fixed;" border=1>
			<tr>
				<td align="center" width="4%" style="border-bottom: solid 1px black; border-right: solid 1px black;"><b>ESTIMATED TIME</b></td>
				<td align="center" width="24%" style="border-bottom: solid 1px black; border-right: solid 1px black; text-align: justify;"><b>LEARNING PRODUCTS</b></td>
				<td align="center" width="24%" style="border-bottom: solid 1px black; border-right: solid 1px black;"><b>CONTENT</b></td>
				<td align="center" width="24%" style="border-bottom: solid 1px black; border-right: solid 1px black;"><b>METHODOLOGY<br><small>LEARNING ACTIVITIES</small></b></td>
				<td align="center" width="24%" style="border-bottom: solid 1px black;"><b>EVALUATION(Evidence)</b></td>
			</tr>
			<tr>
...
%>
						<tr>
							...
							<td ><%=producto.getDescripcion().replaceAll("\n","<br>").replaceAll(" ","&nbsp;")%></td>
						</tr>
<%		} %>
				...
				<td valign="top" id="temas<%=uid %>" style="border-right: solid 1px black;">
					<%=mapaNuevoUnidad.getTemas().replaceAll("\n","<br>").replaceAll(" ","&nbsp;")%>
				</td>
				<td valign="top" width="120px" style="border-right: solid 1px black;">
					<table style="width:100%">
						<tr>
					...
					<table style="width:100%">
						<tr>
							<td colspan="2">								  
							  ...
							  <br>
								<%=mapaNuevoUnidad.getAccionDocente()%>
							</td>
						</tr>
					</table>
				</td>
...
%>
		...
		<tr>
			<td align="center">
				<a href="unidadAccion?planId=<%=planId%>&versionId=<%=versionId%>&cursoId=<%=cursoId%>&unidadId=0" class="btn btn-success btn-sm">
					<i class='icon-plus icon-white'></i>&nbsp; Add Unit
				</a>
			</td>
		</tr>
	</table>
	...
	<table style="width:850px" style="border: solid 1px black;">
		...
		<tr>
			<td><b>MEANS AND TEACHING RESOURCES:</b></td>
		</tr>
		<tr>
		...
		<tr>
			<td><b>GRADING SCALE (Weighting of grades):</b></td>
		</tr>
		<tr>
	...
	<table>
		<tr>
			<td><input type="button" class="btn btn-primary" value="Save" onclick="revisaFormaCurso();" /></td>
		</tr>
	</table>
	<br>
	...
	<input type="hidden" id="planId" name="planId" value="<%=planId%>" />
		...
		<table style="width:850px" style="border: solid 1px black;" id="bibliografiaTotal">
			<tr>
				<td align="center" colspan="3"><b>BIBLIOGRAPHY TOTAL</b></td>
			</tr>
<%
		tipo = "";
...
%>
			<tr>
				<td colspan="3"><b><%=tipo.equals("1")?"Books and magazines:":"Electronic links:" %></b></td>
			</tr>
<%
			}
%>
...
%>
			<tr>
				...
				<a href="biblioAccion?planId=<%=planId%>&versionId=<%=versionId%>&cursoId=<%=cursoId%>&unidadId=0" class="btn btn-success btn-sm">
						<i class='icon-plus icon-white'></i>&nbsp; Add Bibliography
					</a>
				</td>
			</tr>
		</table>
	...
	<table>
		<tr>
			<td><input type="button" class="btn btn-primary" value="Close Subject" onclick="cerrarMateria();" /></td>
		</tr>
	</table>
	<script type="text/javascript">
		inicio();
