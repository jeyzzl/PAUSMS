...
<div class="container-fluid">
	<h1><spring:message code="aca.Editar"/> <spring:message code="aca.Plan"/></h1>
	<form id="forma" name="forma" action="editaPlan">
		...
		<div class="row">
			<div class="col-3">
				<label><spring:message code="aca.Plan"/> ID</label>
<%
	if(planId != null){
%>
				 <%=planId %>
...
%>
				...
				<input type="text" class="form-control" id="nombre" name="nombre" value="<%=mapaNuevoPlan.getNombre() %>" size="30" maxlength="100" />
				<br><br>
				<label><spring:message code="aca.Carrera"/></label>
				<select id="carreraId" name="carreraId" class="form-select" ">
					<optgroup label="">
<%
...
%>
				...
				<br><br>
				<label><spring:message code="aca.Periodos"/>:</label>
				<select id="tipo" name="tipo" class="form-select">
				    <option value="S" <%=mapaNuevoPlan.getTipo().equals("S")?"Selected":""%>><spring:message code="aca.Semestres"/></option>
				    <option value="T" <%=mapaNuevoPlan.getTipo().equals("T")?"Selected":""%>><spring:message code="aca.Tetramestres"/></option>
				    <option value="A" <%=mapaNuevoPlan.getTipo().equals("A")?"Selected":""%>><spring:message code="aca.Anos"/></option>
			  	</select>
				<br><br>
				<label><spring:message code="aca.Version"/></label>
				<input type="text" class="form-control" id="versionNombre" name="versionNombre" value="<%=mapaNuevoPlan.getVersionNombre() %>" size="8" maxlength="50" <%=planId != null ? "Disabled" : "" %> />&nbsp;<i>Sugerencia: 0.01</i>
				<br><br>
			</div>
			<div class="col-3">
				<label><spring:message code="aca.Idioma"/>:</label>
				<select id="idioma" name="idioma" class="form-select">
					<option value="E" <%=mapaNuevoPlan.getIdioma().equals("E")?"Selected":""%>><spring:message code="aca.Espanol"/></option>
				    <option value="I" <%=mapaNuevoPlan.getIdioma().equals("I")?"Selected":""%>><spring:message code="aca.Ingles"/></option>				   
			  	</select>
				<br><br>
				<label class="alert alert-info"><spring:message code="aca.mapa.diamante.editaPlan.Frase1"/></label>
				<br>
				<spring:message code="aca.mapa.diamante.editaPlan.HTS"/> : <input type="checkbox" id="hts" name="hts" value="S" <%=mapaNuevoPlan.getHts().equals("S")?"checked=\"checked\"":"" %>/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<spring:message code="aca.mapa.diamante.editaPlan.HPS"/> : <input type="checkbox" id="hps" name="hps" value="S" <%=mapaNuevoPlan.getHps().equals("S")?"checked=\"checked\"":"" %>/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<spring:message code="aca.mapa.diamante.editaPlan.HEI"/> :&nbsp;&nbsp;<input type="checkbox" id="hei" name="hei" value="S" <%=mapaNuevoPlan.getHei().equals("S")?"checked=\"checked\"":"" %>/>
				<br><br>

				<spring:message code="aca.mapa.diamante.editaPlan.HFD"/> : <input type="checkbox" id="hfd" name="hfd" value="S" <%=mapaNuevoPlan.getHfd().equals("S")?"checked=\"checked\"":"" %>/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<spring:message code="aca.mapa.diamante.editaPlan.HSS"/> : <input type="checkbox" id="hfd" name="hss" value="S" <%=mapaNuevoPlan.getHss().equals("S")?"checked=\"checked\"":"" %>/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<spring:message code="aca.mapa.diamante.editaPlan.HAS"/> : <input type="checkbox" id="hfd" name="has" value="S" <%=mapaNuevoPlan.getHas().equals("S")?"checked=\"checked\"":"" %>/>
				<br><br>
				<spring:message code="aca.Ano"/> : <input type="text" name="year"class="form-control" value="<%=year%>" >
			</div>
		</div>
		<div class="alert alert-info">
			<input type="button" class="btn btn-primary" style="button" value=<spring:message code="aca.Guardar"/> onclick="revisaForma();" />
		</div>
