...
<%
	...
	String dir = application.getRealPath("/WEB-INF/pdf/materia/")+"/"+(planId.contains("*") ? planId.substring(0,planId.length()-1) : planId)+cursoId+".pdf";
	...
	try{		
            ...
            public void onEndPage(PdfWriter writer, Document document) {
            	if(writer.getPageNumber() > 0){
	        		...
	        		try{
	        	        ...
	        	        PdfPCell footerCell = new PdfPCell(new Phrase(mapaNuevoPlan.getNombre()+" plan 2010 - "+mapaNuevoCurso.getNombre(),
        ...
        document.open();
            ...
            parrafo.add(new Phrase("Created "
            		, FontFactory.getFont(FontFactory.HELVETICA, 6, Font.BOLD, new Color(r,g,b))));
            parrafo.add(new Phrase("by the State\nGovernment of Nuevo\nLeón, México, by\nOfficial resolution\nissued on may 5,1973\n\n"
            		, FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL, new Color(r,g,b))));
            ...
            /*celda = new PdfPCell(new Phrase(" "
            		, FontFactory.getFont(FontFactory.HELVETICA, 12, Font.BOLD, new Color(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_CENTER);
			celda.setBorder(Rectangle.NO_BORDER);
			tituloCurso.addCell(celda);*/
            
            celda = new PdfPCell(new Phrase(institucion.toUpperCase()
            		, FontFactory.getFont(FontFactory.HELVETICA, 16, Font.BOLD, new Color(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_CENTER);
			celda.setBorder(Rectangle.NO_BORDER);
			tituloCurso.addCell(celda);
			...
			celda = new PdfPCell(new Phrase(aca.catalogo.CatFacultadUtil.getNombreFacultad(conEnoc, aca.catalogo.CatCarreraUtil.getFacultadId(conEnoc, mapaNuevoPlan.getCarreraId()))
					, FontFactory.getFont(FontFactory.HELVETICA, 14, Font.BOLD, new Color(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_CENTER);
			celda.setBorder(Rectangle.NO_BORDER);
			tituloCurso.addCell(celda);
    		...
    		//-------------------------------------------------------------
    		celda = new PdfPCell(new Phrase(" "
					, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new Color(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_LEFT);
    		...
    		celda = new PdfPCell(new Phrase("SUBJECT:"
					, FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD, new Color(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_LEFT);
			celda.setBorder(Rectangle.RECTANGLE);
			cabeceraCurso.addCell(celda);
    		
    		celda = new PdfPCell(new Phrase(mapaNuevoCurso.getNombre()
					, FontFactory.getFont(FontFactory.HELVETICA, 10, Font.NORMAL, new Color(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_LEFT);
			celda.setBorder(Rectangle.RECTANGLE);
			cabeceraCurso.addCell(celda);
    		...
    		celda = new PdfPCell(new Phrase("SERIALIZING:"
					, FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD, new Color(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_LEFT);
			celda.setBorder(Rectangle.RECTANGLE);
			cabeceraCurso.addCell(celda);
    		...
    		if(mapaNuevoPlan.getHts().equals("S")){
				celda = new PdfPCell(new Phrase("HTS:"
						, FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD, new Color(r,g,b))));
				celda.setHorizontalAlignment(Element.ALIGN_LEFT);
				celda.setBorder(Rectangle.RECTANGLE);
    		...
    		if(mapaNuevoPlan.getHps().equals("S")){
				celda = new PdfPCell(new Phrase("HPS:"
						, FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD, new Color(r,g,b))));
				celda.setHorizontalAlignment(Element.ALIGN_LEFT);
				celda.setBorder(Rectangle.RECTANGLE);
				horasCreditos.addCell(celda);
    		...
    		if(mapaNuevoPlan.getHei().equals("S")){
	    		celda = new PdfPCell(new Phrase("HEI:"
						, FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD, new Color(r,g,b))));
				celda.setHorizontalAlignment(Element.ALIGN_CENTER);
				celda.setBorder(Rectangle.RECTANGLE);
				horasCreditos.addCell(celda);
    		...
    		celda = new PdfPCell(new Phrase("THS:"
					, FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD, new Color(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_CENTER);
			celda.setBorder(Rectangle.RECTANGLE);
			horasCreditos.addCell(celda);
			...
			cabeceraCurso.addCell(celda);
			//-------------------------------------------------------------
			celda = new PdfPCell(new Phrase("COMPETENCE PROFILE ATTENDED BY COURSE:"
					, FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD, new Color(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_LEFT);
			celda.setBorder(Rectangle.RECTANGLE);
			celda.setColspan(4);
    		...
    		//-------------------------------------------------------------
    		celda = new PdfPCell(new Phrase("OBJECTIVE OF THE COURSE:"
					, FontFactory.getFont(FontFactory.HELVETICA, 12, Font.BOLD, new Color(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_CENTER);
			celda.setBorder(Rectangle.RECTANGLE);
			objetivoCurso.addCell(celda);
			...
			Phrase p = new Phrase(1.5f, mapaNuevoCurso.getDescripcion()
					, FontFactory.getFont(FontFactory.HELVETICA, 12, Font.NORMAL, new Color(r,g,b)));
			...
			for(int j = 0; j < listUnidades.size(); j++){
	    		...
	    		celda = new PdfPCell(new Phrase("THEMES AND SUBTHEMES"
						, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new Color(r,g,b))));
				celda.setHorizontalAlignment(Element.ALIGN_CENTER);
				celda.setBorder(Rectangle.RECTANGLE);
				celda.setPadding(0f);
	    		...
	    		celda = new PdfPCell(new Phrase("REFERENCES"
						, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new Color(r,g,b))));
				celda.setHorizontalAlignment(Element.ALIGN_CENTER);
				celda.setBorder(Rectangle.RECTANGLE);
				celda.setPadding(0f);
				...
				celda = new PdfPCell(new Phrase(mapaNuevoUnidad.getTiempo()
						, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new Color(r,g,b))));
				celda.setHorizontalAlignment(Element.ALIGN_LEFT);
				celda.setBorder(Rectangle.RECTANGLE);
				celda.setPadding(0f);
				unidad.addCell(celda);
			...
			celda = new PdfPCell(new Phrase("MEDIA AND LEARNING RESOURCES:"
					, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new Color(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_LEFT);
			celda.setBorder(Rectangle.RECTANGLE);
			pieCurso.addCell(celda);
			...
			celda = new PdfPCell(new Phrase("ELEMENTS OF ASSESSMENT"
					, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new Color(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_LEFT);
			celda.setBorder(Rectangle.RECTANGLE);
			pieCurso.addCell(celda);
	...
	String nombreArchivo = (planId.contains("*") ? planId.substring(0,planId.length()-1) : planId)+cursoId+".pdf";
