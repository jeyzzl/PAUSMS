...
<%
	...
	mapaNuevoCurso.mapeaRegIdPorCursoID(conEnoc, cursoId);
	...
	try{ 
            ...
            public void onEndPage(PdfWriter writer, Document document) {
            	if(writer.getPageNumber() > 0){
	        		...
	        		try{
	        	        ...
	        	        PdfPCell footerCell = new PdfPCell(new Phrase(mapaNuevoPlan.getNombre()+" plan "+mapaNuevoCurso.getPlanId()+" - "+mapaNuevoCurso.getNombre(),
        ...
        document.open();
			...
			celda = new PdfPCell(new Phrase("HORAS TOTALES:"
					, FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD, new BaseColor(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_LEFT);
			celda.setBorder(Rectangle.RECTANGLE);
			cabeceraCurso.addCell(celda);
    		...
    		//-------------------------------------------------------------
    		celda = new PdfPCell(new Phrase("OBJETIVO DE LA ASIGNATURA:"
					, FontFactory.getFont(FontFactory.HELVETICA, 12, Font.BOLD, new BaseColor(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_CENTER);
			celda.setBorder(Rectangle.RECTANGLE);
			objetivoCurso.addCell(celda);
			...
			for(int j = 0; j < listUnidades.size(); j++){
	    		...
	    		celda = new PdfPCell(new Phrase("NOMBRE Y OBJETIVO DE LA UNIDAD"
						, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
				celda.setHorizontalAlignment(Element.ALIGN_CENTER);
				celda.setBorder(Rectangle.RECTANGLE);
				celda.setPadding(0f);
	    		...
	    		celda = new PdfPCell(new Phrase("TEMAS Y SUBTEMAS"
						, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
				celda.setHorizontalAlignment(Element.ALIGN_CENTER);
				celda.setBorder(Rectangle.RECTANGLE);
				celda.setPadding(0f);
	    		...
	    		celda = new PdfPCell(new Phrase("OBJETIVO:"
						, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
				celda.setHorizontalAlignment(Element.ALIGN_LEFT);
				celda.setBorder(Rectangle.NO_BORDER);
				celda.setPadding(0f);
				...
				for(int k = 0; k < listActividades.size(); k++){
					...
					if(!tipo.equals(mapaNuevoActividad.getTipo())){
						...
						celda = new PdfPCell(new Phrase(tipo.equals("1")?"Conocimientos:":tipo.equals("2")?"Habilidades:":"Actitudes:"
								, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
						celda.setHorizontalAlignment(Element.ALIGN_LEFT);
						celda.setBorder(Rectangle.NO_BORDER);
						celda.setPadding(0f);
				...
				for(int k = 0; k < listActividades.size(); k++){
					...
					if(!tipo.equals(mapaNuevoActividad.getTipo())){
						...
						celda = new PdfPCell(new Phrase(tipo.equals("1")?"CONOCIMIENTO (Saber)":tipo.equals("2")?"HABILIDAD (Saber hacer)":"ACTITUD (Saber ser)"
								, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
						celda.setHorizontalAlignment(Element.ALIGN_LEFT);
						celda.setBorder(Rectangle.NO_BORDER);
						celda.setPadding(0f);
					...
					celda = new PdfPCell(new Phrase("Criterio de desempeño:"
							, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
					celda.setHorizontalAlignment(Element.ALIGN_LEFT);
					celda.setBorder(Rectangle.NO_BORDER);
					celda.setPadding(0f);
    		...
    		celda = new PdfPCell(new Phrase("ACCIÓN DOCENTE (Metodología):"
					, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_LEFT);
			celda.setBorder(Rectangle.RECTANGLE);
			pieCurso.addCell(celda);
