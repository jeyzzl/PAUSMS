...
<% 
	...
	String versionId		= request.getParameter("versionId")==null?"1":request.getParameter("versionId");
...
<input type="button" class="btn btn-primary" value="Editar Unidades" onclick="document.location = 'editaUnidad?planId=<%=planId %>&versionId=<%=versionId %>&cursoId=<%=cursoId %>&Opcion=1';" style="position: fixed; top: 130px; left: 30px;" />
<%
...
%>
	...
	<br>
	<table style="width:850px" align="center" style="border: solid 1px black;" border=1 class="tabla">
		<tr>
