...
<head>
	...
	<script type="text/javascript"><!--
		...
		function nuevaUnidad(){
			...
			new Ajax.Request(url,{
				...
				onSuccess: function(req){
					...
					$("btnUnidad").innerHTML='<tr><td align="center"><input type="button" class="button" value="Save" onclick="guardarUnidad();" /><input type="button" class="button" value="Cancel" onclick="cancelarNuevaUnidad();" /></td></tr>';
					$("tiempo").focus();
				},
				onFailure: function(req){
		...
		function cancelarNuevaUnidad(){
			$("nuevo").innerHTML = '';
			$("btnUnidad").innerHTML='<tr><td align="center" class="button" height="20px" onclick="nuevaUnidad();">Add Unit</td></tr>';
		}
		...
		function editarUnidad(unidadId){
			...
			$("unidad"+unidadId).insert({
				bottom: '<input type="button" class="button" id="btnEditaUnidadG" value="Save" onclick="modificarUnidad(\''+unidadId+'\');" />'+
						'<input type="button" class="button" id="btnEditaUnidadC" value="Cancel" onclick="cancelarEditarUnidad();" />'
			});
		}
		...
		function editarAccionDocente(unidadId){
			...
			div.innerHTML = '<table>'+
								...
								'<tr>'+
									'<td align="center">'+
										'<input type="button" class="button" value="Save" onclick="modificarAccionDocente(\''+unidadId+'\');" />'+
										'<input type="button" class="button" value="Cancel" onclick="cancelarEditarAccionDocente();" />'+
									'</td>'+
								'</tr>'+
							'</table>';
			$("accionDocente").focus();
		...
		function nuevoObjetivo(unidadId){
			...
			div.innerHTML = '<table>'+
						...
						'</tr>'+
							'<tr>'+
								'<td align="center">'+
									'<input type="button" class="button" value="Save" onclick="guardarObjetivo(\''+unidadId+'\');" />'+
									'<input type="button" class="button" value="Cancel" onclick="cancelarNuevoObjetivo();" />'+
								'</td>'+
							'</tr>'+
						'</table>';
			$("objetivo").focus();
		...
		function editarObjetivo(unidadId, actividadId){
			...
			div.innerHTML = '<table>'+
								...
								'<tr>'+
									'<td align="center">'+
										'<input type="button" class="button" value="Save" onclick="modificarObjetivo(\''+unidadId+'\', \''+actividadId+'\');" />'+
										'<input type="button" class="button" value="Cancel" onclick="cancelarEditarObjetivo();" />'+
										'<input type="button" class="button" value="Delete" onclick="borrarObjetivo(\''+unidadId+'\', \''+actividadId+'\');" />'+
									'</td>'+
								'</tr>'+
							'</table>';
			$("objetivo").focus();
		...
		function editarActividad(unidadId, actividadId){
			...
			div.innerHTML = '<table>'+
								...
								'<tr>'+
									'<td align="center">'+
										'<input type="button" class="button" value="Save" onclick="modificarActividad(\''+unidadId+'\', \''+actividadId+'\');" />'+
										'<input type="button" class="button" value="Cancel" onclick="cancelarEditarActividad();" />'+
									'</td>'+
								'</tr>'+
							'</table>';
			$("actividad").focus();
		...
		function editarCriterio(unidadId, actividadId){
			...
			div.innerHTML = '<table>'+
								...
								'<tr>'+
									'<td align="center">'+
										'<input type="button" class="button" value="Save" onclick="modificarCriterio(\''+unidadId+'\', \''+actividadId+'\');" />'+
										'<input type="button" class="button" value="Cancel" onclick="cancelarEditarCriterio();" />'+
									'</td>'+
								'</tr>'+
							'</table>';
			$("criterio").focus();
			...
			div.innerHTML = '<table style="width:100%">'+
								...
								'<tr>'+
									...
									'<td>'+
										'<select id="tipoBibliografia">'+
											'<option value="1">Books and Magazines</option>'+
								...
								'<tr>'+
									'<td align="center" colspan="2">'+
										'<input type="button" class="button" value="Save" onclick="guardarBibliografiaGlobal(\''+unidadId+'\');"/>'+
										'<input type="button" class="button" value="Cancel" onclick="cancelarNuevaBibliografia();" />'+
									'</td>'+
								'</tr>'+
							'</table>';
			$("bibliografia").focus();
		...
		function editarBibliografia(unidadId, bibliografiaId, id){
			...
			div.innerHTML = '<table>'+
								...
								'<tr>'+
									'<td align="center">'+
										'<input type="button" class="button" value="Save" onclick="modificarBibliografia(\''+unidadId+'\', \''+bibliografiaId+'\', \''+id+'\');" />'+
										'<input type="button" class="button" value="Cancel" onclick="cancelarEditarBibliografia();" />'+
										'<input type="button" class="button" value="Delete" onclick="borrarBibliografia(\''+unidadId+'\', \''+bibliografiaId+'\', \''+id+'\');" />'+
									'</td>'+
								'</tr>'+
							'</table>';
			$("bibliografia").focus();
			...
			if(!div){
				$(document.body).insert({
					bottom: '<div id="editaObjetivoAsignatura">'+
								...
								'&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" class="button" value="Save" onclick="modificarObjetivoAsignatura();" />'+
								'<input type="button" class="button" value="Cancel" onclick="cancelarEditaObjetivoAsignatura();" />'+
							'</div>'
				});
...
<body>
	...
	<table style="width:850px" align="center" style="border: solid 1px black;" border=1>
		...
		<tr>
			<td width="180px"><b>COURSE OBJECTIVE:</b></td>
...
%>
		...
		<tr>
			<td colspan="6"><b>COMPETENCE PROFILE ATTENDING BY THE SUBJECT:</b></td>
...
%>
		<div id="unidad<%=mapaNuevoUnidad.getUnidadId() %>" align="center" onmouseover="this.style.backgroundColor = '#dddddd';" onmouseout="this.style.backgroundColor = '';">
			<table style="width:850px" align="center">
				<tr>
					<td>
						<img class="button" title="Editar" src="../../imagenes/editar.gif" title="Edit" onclick="editarUnidad('<%=uid %>');" />
						<img class="button" title="Eliminar" src="../../imagenes/no.png" title="Delete" onclick="borrarUnidad('<%=uid %>');" />
					</td>
				</tr>
			</table>
			<br>
			<table style="width:850px" align="center" style="border: solid 1px black;">
				<tr>
					...
					<td align="center" width="120px" style="border-bottom: solid 1px black; border-right: solid 1px black;"><b>NAME AND PURPOSE OF THE UNIT</b></td>
					<td align="center" style="border-bottom: solid 1px black; border-right: solid 1px black;"><b>TOPICS AND SUBTOPICS</b></td>
					<td align="center" width="120px" style="border-bottom: solid 1px black; border-right: solid 1px black;"><b>LEARNING ACTIVITIES</b></td>
					<td align="center" width="120px" style="border-bottom: solid 1px black;"><b>BIBLIOGRAPHY</b></td>
				</tr>
				<tr>
...
%>
							<tr>
								<td colspan="2"><b><%=tipo.equals("1")?"Knowledge:":tipo.equals("2")?"Skills:":"Attituedes:" %></b></td>
							</tr>
<%
			}
%>
...
%>
							<tr>
								<td colspan="2"><input type="button" class="button" value="Add" id="btnAgregarObjetivo<%=uid %>" onclick="nuevoObjetivo('<%=uid %>');" /></td>
							</tr>
						</table>
					</td>
...
%>
							...
							<tr>
								<td colspan="2"><input type="button" class="button" value="Add" id="btnAgregarBibliografia<%=uid %>" onclick="nuevaBibliografia('<%=uid %>');" /></td>
							</tr>
						</table>
					</td>
				</tr>
...
%>
	...
	<table style="width:850px" align="center" style="border: dotted 1px gray;" id="btnUnidad">
		<tr>
			<td align="center" class="button" height="20px" onclick="nuevaUnidad();">Add Unit</td>
		</tr>
	</table>
	<br>
	...
	<table style="width:850px" align="center" style="border: solid 1px black;">
		<tr>
			<td><b>TEACHING ACTION (Methodology):</b></td>
		</tr>
		<tr>
			<td>
...
%>
	...
	<table style="margin: 0 auto;">
		<tr>
			<td><input type="button" class="button" value="Save" onclick="revisaFormaCurso();" /></td>
		</tr>
	</table>
	<br>
...
%>
		<tr>
			<td colspan="3"><b><%=tipo.equals("1")?"Books and Magazines:":"Links:" %></b></td>
		</tr>
<%
		}
%>
		<tr>
			<td width="35px" valign="top" style="border-right: solid 1px gray;">
				<img class="button" title="Editar" src="../../imagenes/editar.gif" title="Edit" onclick="editarBibliografiaGlobal('<%=mapaNuevoBibliografia.getBibliografiaId() %>');" />
				<img class="button" title="Eliminar" src="../../imagenes/no.png" title="Delete" onclick="borrarBibliografiaGlobal('<%=mapaNuevoBibliografia.getBibliografiaId() %>');" />
			</td>
...
%>
		<tr>
			<td colspan="3" align="center"><input type="button" class="button" id="btnAgregarBibliografiaGlobal" value="Add Global References" onclick="nuevaBibliografiaGlobal('-');" /></td>
		</tr>
	</table>
	<br>
	<br>
