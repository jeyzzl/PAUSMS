...
<div class="container-fluid">
	...
	<div class="alert alert-info">
		<a class="btn btn-primary" href="metas_empleados"><i class="icon-arrow-left icon-white"></i><spring:message code='aca.Regresar'/></a>
	</div>
...
<%
	...
	java.util.List<Logro> lsLogro = el.listLogrosMeta(metaId, codigoPersonal);
