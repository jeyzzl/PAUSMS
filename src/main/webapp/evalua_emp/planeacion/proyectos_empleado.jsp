...
<div class="container-fluid">
	...
	<div class="alert alert-info">
		<%=empleado %> | <%=aca.vista.UsuariosUtil.getNombreUsuario(conEnoc, empleado, "NOMBRE") %>
	</div>
	
	<div class="alert alert-info">
		<a class="btn btn-primary" href="misionvision"><i class="icon-arrow-left icon-white"></i><spring:message code='aca.Regresar'/></a>
	</div>
...
<%
	...
	java.util.List<Logro> lsLogro = el.listLogros(0, empleado, "");
