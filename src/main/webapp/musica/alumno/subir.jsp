...
<table class="goback">
	<tr>
		<td><a href="datos" class="btn btn-primary">&lsaquo;&lsaquo; <spring:message code="aca.Regresar"/></a></td>
	</tr>
</table>
<table style="width:80%; margin:0 auto;"   >
  ...
  <tr>
	<td align="center"style="font-size:10pt;">Alumno: [<%=codigoId%>] - <%= aca.musica.MusiAlumno.getNombre(conEnoc, codigoId, "NOMBRE" ) %></td>
  </tr>
</table>
<br>
<form name="formaEnviar" id="formaEnviar" enctype="multipart/form-data" action="guardar" method="post">
<table style="width:80%; margin:0 auto;" class="table">
	<tr>
		<td>
			<b>Elije la foto</b><br>
			<input type="file" id="archivo" name="archivo" /><br>
			<input class="btn btn-primary" type="button" id="btnGuardar" value="Guardar" onclick="guardar();" />
		</td>
	</tr>
</table>
</form>
