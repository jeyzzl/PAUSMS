...
if((trabAlum.getMatricula().equals(matricula))){
    ...
    HashMap<String,String> mapaHorasTotPorSemana    = (HashMap<String,String>) request.getAttribute("mapaHorasTotPorSemana");
            ...
            if (curInformeFecha != null && !curInformeFecha.isEmpty()) {
                try {
                    ...
                    if (currentWeekNumber != weekNumber) {
                        ...
                        String weekTotHours = mapaHorasTotPorSemana.containsKey(matricula+weekStartDate) ? mapaHorasTotPorSemana.get(matricula+weekStartDate) : "0";
                        double weekOustanding = defaultWeekMin - Double.parseDouble(weekHours);
                        double weekSurplus = Double.parseDouble(weekTotHours) - defaultWeekMin;
                        if (weekOustanding < 0) weekOustanding = 0;   
                        if (weekSurplus < 0) weekSurplus = 0;
            ...
            <tr class="table-secondary">
                <td colspan="10" class="text-center">
                    ...
                    <div>
                        ...
                        <small>Surplus <span class="badge bg-primary"><%=String.format("%.2f", weekSurplus)%></span></small>
                    </div>
                </td>
            </tr>
<%                  
