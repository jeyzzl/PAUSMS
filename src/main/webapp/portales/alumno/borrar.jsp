...
<%
	...
	String dirFoto = application.getRealPath("/WEB-INF/fotos2/"+codigoAlumno+".jpg");	
	...
	if (borrar){
		out.print("<div class='alert alert-success'><b>Registrado...<a class='btn btn-primary' href='datos'>Regresar</a></div>");
