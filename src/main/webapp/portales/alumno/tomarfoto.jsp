...
<head>
	...
	<script type="text/javascript">	
		...
		function my_completion_handler(msg) {
			...
			'<br><img height=340 src=fotoEnviada?mat=<%=matricula%>&hola='+encodeURIComponent(new Date())+'>';
...
<table style="width:77%"   align="center" bordercolor="#CCCCCC" border="1">
  <tr>
    <th style="font-size:12pt;" align="center" colspan="2">
      <b>Alumno: [<%=matricula %>] &nbsp; <%=aca.alumno.AlumUtil.getNombreAlumno(conEnoc, matricula, "NOMBRE") %></b>
    </th>
  </tr>    
  <tr>
        ...
        <tr>
          <td align="center">
      		<div id="resultado" style="margin-top:1em;-moz-border-radius:12px; background-color:#ddd;width:360px;text-align:center;height:500px;padding-top:15px;margin-bottom:1em;">
      		  ...
      		  <img height="340" src="fotoEnviada?mat=<%=matricula%>">
      		</div>
      	  </td>
      	</tr>
      	<tr>
    	  <td align="center"><a href="datos" style="font-size:11pt;">&lsaquo;&lsaquo; Regresar a Datos</a></td>
	  	</tr>
     </table> 	  	
    </td>
  </tr>    
