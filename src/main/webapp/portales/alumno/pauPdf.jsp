...
<%
	...
	String fechaGraduacion 	= (String)request.getAttribute("fechaGraduacion");
...
//------PDF----->		
    ...
    //Logo Um y texto debajo
    	...
    	//Award date of Issue
    	Phrase date_issue = new Phrase("AWARD (DATE OF ISSUE): "+fechaGraduacion, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(0,0,0)));
