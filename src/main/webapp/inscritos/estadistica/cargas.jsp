...
<%
	...
	if (accion.equals("1")){		
		...
		for(int i = 0; i < lisCargas.size(); i++){
			Carga carga = (Carga) lisCargas.get(i);
...
<div class="container-fluid">
	...
	<div class="alert alert-info d-flex align-items-center">
		...
		Date:
		<input type="text" id="Fecha" name="Fecha" class="form-control" maxlength="10" data-date-format="dd/mm/yyyy" value="<%=fInscripcion %>" style="margin:0;width:120px;"/>&nbsp;
