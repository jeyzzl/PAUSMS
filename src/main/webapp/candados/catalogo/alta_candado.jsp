...
<div class="alert alert-info">
	...
	<a class="btn btn-primary" href="editarCandado?TipoId=<%=tipoId%>"><spring:message code="aca.A�adir"/></a>
</div>
...
%>
  		<tr> 
  			<td>
				<a href="editarCandado?CandadoId=<%=candado.getCandadoId()%>&TipoId=<%=tipoId%>" class="fas fa-edit" title="Edit"></a>
				<a href="borrarCandado?CandadoId=<%=candado.getCandadoId()%>&TipoId=<%=tipoId%>" class="fas fa-trash text-danger" title="Delete"></a>
			</td>
