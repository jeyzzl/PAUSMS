...
<%
	...
	HashMap<String,String> mapaCandadosPorTipo = (HashMap<String,String>)request.getAttribute("mapaCandadosPorTipo");
	if (esAdmin == true) {
%>
<div class="container-fluid">
	...
	<table id="table" class="table table-sm table-bordered">
		...
		for (CandTipo candTipo : lisTipos) {
			...
			String candados = "0";
			if(mapaCandadosPorTipo.containsKey(candTipo.getTipoId())){
				candados = mapaCandadosPorTipo.get(candTipo.getTipoId());
			}
		%>
		<tr>
			<td align="center"><%=candTipo.getTipoId()%></td>
			<td style="text-align: center;">
				<a href="cand_tipo?TipoId=<%=candTipo.getTipoId()%>" class="fas fa-edit" title="Editar"></a>
<%		if(permisos.equals("0") && candados.equals("0")){%>
				<a href="borrarTipo?TipoId=<%=candTipo.getTipoId()%>" class="fas fa-trash text-danger" title="Delete"></a>
<%		}%>	
			</td>
