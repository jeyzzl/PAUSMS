		...
		for(Estadistica estadistica :lisAlumnos){
			if (estadistica.getCarreraId().equals(catCarrera.getCarreraId())){
				...
				if(!matricula.equals(estadistica.getCodigoPersonal())){
					...
					*/
					String disciplina = "0";
					if (mapaCandados.containsKey(matricula+"1")){
						disciplina =  mapaCandados.get(matricula+"1");
					}
					
					String ingreso = "0";
					if (mapaCandados.containsKey(matricula+"2")){
						ingreso =  mapaCandados.get(matricula+"2");
					}
					
					String biblioteca = "0";
					if (mapaCandados.containsKey(matricula+"3")){
						biblioteca =  mapaCandados.get(matricula+"3");
					}
					
					String finanzas = "0";
					if (mapaCandados.containsKey(matricula+"4")){
						finanzas =  mapaCandados.get(matricula+"4");
					}					
					
					String ctp = "0";
					if (mapaCandados.containsKey(matricula+"5")){
						ctp =  mapaCandados.get(matricula+"5");
					}
					
					String extranjero = "0";
					if (mapaCandados.containsKey(matricula+"6")){
						extranjero =  mapaCandados.get(matricula+"6");
					}
					
					String vre = "0";
					if (mapaCandados.containsKey(matricula+"7")){
						vre =  mapaCandados.get(matricula+"7");
					}

					String vrf = "0";
					if (mapaCandados.containsKey(matricula+"8")){
						vrf =  mapaCandados.get(matricula+"8");
					}				
					
					String residencia = "0";
					if (mapaCandados.containsKey(matricula+"9")){
						residencia =  mapaCandados.get(matricula+"9");
					}
...
%>
		<tr class="tr2">
			...
			<td><%=ctp.equals("0")?"<span class='badge bg-success'>NO</span>":"<span class='badge bg-warning'>YES</span>"%></td>
