...
<div class="container-fluid">
	<h2>Total Graduates Per Course.</h2>
	...
	<tr>
    	...
    	<th class="text-end">High School</th>
		<th class="text-end">Bachelors</th>
		<th class="text-end">Masters</th>
		<th class="text-end">Doctorate</th>
