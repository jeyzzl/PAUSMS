...
//	email  : pinotoy@yahoo.com
	...
	*/
	...
	if (dom) {
		...
		document.write ('<div onclick="bShow=true" id="calendar" style="z-index:+999;position:absolute;visibility:hidden;"><table style="width:'+((showWeekNumber==1)?250:220)+'" style="font-family:Arial;font-size:11px;border: 1px solid #A0A0A0;" bgcolor="#ffffff"><tr bgcolor="#000066"><td><table style="width:'+((showWeekNumber==1)?248:218)+'"><tr><td style="padding:2px;font-family:Arial;font-size:11px;"><font color="#ffffff' + '' /*C9D3E9*/ +'"><b><span id="caption"></span></b></font></td><td align="right"><a href="javascript:hideCalendar()"><img src="'+imgDir+'pcalclose.gif" width="15" height="13" border="0" /></a></td></tr></table></td></tr><tr><td style="padding:5px" bgcolor="#ffffff"><span class="container-fluid"></span></td></tr>');
	...
	function constructYear() {
		...
		if (!yearConstructed) {
			...
			document.getElementById('selectYear').innerHTML = '<table style="width:44" cellspacing="0" bgcolor="#f0f0f0" style="font-family:Arial;font-size:11px;border:1px solid #a0a0a0;" onmouseover="clearTimeout(timeoutID2)" onmouseout="clearTimeout(timeoutID2);timeoutID2=setTimeout(\'popDownYear()\',100)">' + sHTML + '</table>';
	...
	function popUpCalendar(ctl, ctl2, format) {
		...
		if (bPageLoaded) {
			if (crossobj.visibility == 'hidden') {
				...
				crossobj.left = (fixedX == -1) ? ctl.offsetLeft + ctl.offsetWidth + leftpos : fixedX;
