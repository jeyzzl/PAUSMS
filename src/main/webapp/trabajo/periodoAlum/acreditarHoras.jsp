...
<%  }%> 
    ...
    <form action="grabarHoras" name="frmHorasAlum" method="post">
        ...
        <label for="Descripcion" clas="form-label">Description:</label>
        <textarea class="form-control mb-1" id="Descripcion" name="Descripcion" rows="3" style="width: 25rem;"  maxlength="280"></textarea>
