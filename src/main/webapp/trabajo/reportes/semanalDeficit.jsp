...
<script>
    function cambio(){
		...
		location.href = "semanalDeficit?PeriodoId="+periodoId+"&DeptId="+deptId+"&CatId="+catId+"&Grado="+grado+"&Semana="+semana;
	}
</script>
...
<%      int count = 0;
        ...
        for(TrabAlum alum : lisAlumnos){
            ...
            if(mapaAlumPlan.containsKey(alum.getMatricula())){
                ...
                alumGrado = mapaAlumPlan.get(alum.getMatricula()).getGrado();
            }
