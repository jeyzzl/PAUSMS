...
%>
        ...
        Department:
		<select name="DeptId" id="DeptId" style="width:300px;" class="form-select mx-2" onchange="javascript:cambioPeriodo();">
...
%>
        ...
        Category:
		<select name="CatId" id="CatId" style="width:300px;" class="form-select mx-2" onchange="javascript:cambioPeriodo();">
...
%>
        ...
        Year:
		<select name="Grado" id="Grado" style="width:150px;" class="form-select mx-2" onchange="javascript:cambioPeriodo();">
...
<%      
        ...
        for(TrabAlum alumno : lisAlumnos){
            ...
            if(mapaMaxiComentario.containsKey(alumno.getMatricula())){
                comentario = mapaMaxiComentario.get(alumno.getMatricula());
            }
%>
            <tr>
                <td><%=row%></td>
