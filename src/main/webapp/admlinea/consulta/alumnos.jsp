...
<%
	...
	HashMap<String,aca.admision.spring.AdmSolicitud> mapaReservados 	= (HashMap<String,aca.admision.spring.AdmSolicitud>)request.getAttribute("mapaReservados");
	HashMap<String,aca.admision.spring.AdmAcademico> mapaAcademico 		= (HashMap<String,aca.admision.spring.AdmAcademico>)request.getAttribute("mapaAcademico");
	HashMap<String,aca.catalogo.spring.CatCarrera> mapaCarreras			= (HashMap<String,aca.catalogo.spring.CatCarrera>)request.getAttribute("mapaCarreras");
...
<%		
	...
	for(AdmReservada reservada: lisReservados){
		...
		String estadoId = "-";
		String ciudadId = "-";
		if (mapaReservados.containsKey(reservada.getFolio())){
			aca.admision.spring.AdmSolicitud sol = mapaReservados.get(reservada.getFolio());
			nombreAlumno 	= sol.getNombre()+" "+sol.getApellidoPaterno()+" "+sol.getApellidoMaterno();
			correo 			= sol.getEmail();
		}
