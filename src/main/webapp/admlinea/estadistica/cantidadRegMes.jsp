...
<div class="container-fluid">
	<h1>List of Students<small class="text-muted fs-4">( Registered)</small></h1>
	<div class="alert alert-info">
		<a href="estadistica?Year=<%=year%>" class="btn btn-primary">Return</a>
	</div>
	<table id="tableRegistrados" class="table table-bordered table-striped">
	<thead>
		<tr>
			<th width="2%">#</th>
			<th width="3%">No.</th>
...
<script type="text/javascript">
	jQuery('#tableRegistrados').tablesorter();
</script>
</html>