...
<%	
	...
	String nombre 			= "";
	String dir				= application.getRealPath("/investigacion/proyecto/archivos/"+proyectoId+"FV.pdf");
	int widthImage     		= 0;
	int heightImage			= 0;
	...
	try{		
	    ...
	    nombre			= multi.getFilesystemName("archivoFV");
...
%>
		<div class="container-fluid">
			<div class="alert alert-danger">
				...
				<a href="permisos.jsp?proyectoId=<%=proyectoId%>">Intentar de nuevo</a>
			</div>
		</div>
<%		
	}
	...
	if (guardo ){
		System.gc();
		response.sendRedirect("permisos?proyectoId="+proyectoId);
	}else{
