...
<%	
	...
	String nombre 			= "";
	String dir				= application.getRealPath("/investigacion/proyecto/archivos/"+proyectoId+"Cfd"+".pdf");
	int widthImage     		= 0;
	int heightImage			= 0;
	...
	try{		
	    ...
	    nombre			= multi.getFilesystemName("archivoConf");
...
%>
		<div class="container-fluid">
			<div class="alert alert-danger">
				...
				<a href="permisos?proyectoId=<%=proyectoId%>">Intentar de nuevo</a>
			</div>
		</div>
<%		
	}
