...
<%
	...
	if(accion.equals("1")){
		...
		String dirArchivo		= application.getRealPath("/investigacion/proyecto/archivos/"+proyectoId+".pdf");
		...
		if (borrar && aca.investiga.InvProyectoUtil.updateDocumento(conEnoc, proyectoId, "N")){
