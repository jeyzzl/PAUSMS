...
<%	
	...
	String ruta 			= application.getRealPath("/investigacion/proyecto/archivos")+"/";
	String nombre 			= "";
	String dir				= application.getRealPath("/investigacion/proyecto/archivos/info1/"+proyectoId+".pdf");
	int widthImage     		= 0;
	int heightImage			= 0;
...
%>
		<div class="container-fluid">
			<div class="alert alert-danger">
				...
				<a href="subirInfo1">Intentar de nuevo</a>
			</div>
		</div>
<%		
	}
