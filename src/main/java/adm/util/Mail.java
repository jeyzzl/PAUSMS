...
public class Mail {
	...
	public static void main(String[] args){
		try{
			...
			Mail mail = new Mail();
			String texto = "Gracias por aceptar ayudarnos en el procesod e admisixn de Elier Obed Espinoza Zepeda."+
				...
				"\n\nEsta informacixn tendrx carxcter de reservada, anxnima, y para uso exclusivo en el proceso de admisixn."+
