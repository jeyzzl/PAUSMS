...
public class AdmDocAlum{
	...
	public boolean insertReg(Connection Conn ) throws Exception{
		...
		try{
			...
			System.out.println("Error - aca.admision.AdmDocAlum|insertReg|:"+ex);
		}finally{
	...
	public boolean updateReg(Connection conn ) throws Exception{
		...
		try{
			...
			System.out.println("Error - aca.admision.AdmDocAlum|updateReg|:"+ex);			
		}finally{
			try { ps.close(); } catch (Exception ignore) { }
		}
		return ok;
	...
	public static boolean updateAutoriza(Connection conn, String estado, String usuario, String folio ) throws Exception{
		boolean ok = false;
		PreparedStatement ps = null;
		try{
			ps = conn.prepareStatement("UPDATE SALOMON.ADM_DOCALUM "+
			...
			System.out.println("Error - aca.admision.AdmDocAlum|updateAutoriza|:"+ex);
		}finally{
			try { ps.close(); } catch (Exception ignore) { }
		}
		return ok;
	...
	public boolean deleteReg(Connection conn ) throws Exception{
		...
		try{
			...
			System.out.println("Error - aca.admision.AdmDocAlum|deleteReg|:"+ex);
			ok = false;
		}finally{
			try { ps.close(); } catch (Exception ignore) { }
		}
	...
	public void mapeaRegId( Connection conn, String folio, String documentoId ) throws SQLException{
		...
		PreparedStatement ps = null; 
		try{
			ps = conn.prepareStatement("SELECT FOLIO, DOCUMENTO_ID, ESTADO, USUARIO, COMENTARIO, CARTA"
			...
			System.out.println("Error - aca.admision.AdmDocAlum|mapeaRegId|:"+ex);
			ex.printStackTrace();
		}finally{
	...
	public boolean existeReg(Connection conn) throws SQLException{
		...
		try{
			...
			System.out.println("Error - aca.admision.AdmDocAlum|existeReg|:"+ex);
		}finally{
			try { rs.close(); } catch (Exception ignore) { }
			try { ps.close(); } catch (Exception ignore) { }
		}
	...
	public static boolean tieneDocs(Connection conn, String folio) throws SQLException{
		boolean 		ok 	= false;
		ResultSet 		rs		= null;
		PreparedStatement ps	= null;
		...
		try{
			...
			System.out.println("Error - aca.admision.AdmDocAlum|tieneDocs|:"+ex);
		}finally{
			try { rs.close(); } catch (Exception ignore) { }
			try { ps.close(); } catch (Exception ignore) { }
		}
	...
	public static int numDocs(Connection conn, String folio) throws SQLException{
		ResultSet 		rs		= null;
		PreparedStatement ps	= null;
		int numero		 		= 0;
		
		try{
			ps = conn.prepareStatement("SELECT COUNT(FOLIO) AS FOLIO FROM SALOMON.ADM_DOCALUM WHERE FOLIO = TO_NUMBER(?,'99999999') AND ESTADO = 'E'");
			ps.setString(1,folio);			
			rs = ps.executeQuery();
			if (rs.next())
				numero = rs.getInt("FOLIO");		
		}catch(Exception ex){
			System.out.println("Error - aca.admision.AdmDocAlum|existeReg|:"+ex);
		}finally{
			try { rs.close(); } catch (Exception ignore) { }
