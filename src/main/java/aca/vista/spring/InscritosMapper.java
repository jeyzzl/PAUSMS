...
public class InscritosMapper implements RowMapper<Inscritos>{

	public Inscritos mapRow(ResultSet rs, int arg1) throws SQLException {
		
		Inscritos objeto = new Inscritos();
