...
@Controller
public class ContInscritosInscritosPrimero {
	...
	@RequestMapping("/inscritos/primeros/cargas")
	public String inscritosPrimerosCargas(HttpServletRequest request, Model modelo){
		...
		return "inscritos/primeros/cargas";
	}
	
	@RequestMapping("/inscritos/primeros/grados")
	public String inscritosPrimerosGrados(HttpServletRequest request){
		enviarConEnoc(request,"Error-aca.ContinscritosPrimerosGrados|inscritosPrimerosGrados:");
		//enviarConArchivo(request,"Error-aca.ControllerDatosAlumno|credencialEmpDatoDep:");		
		return "inscritos/primeros/grados";
	}
	
	
	@RequestMapping("/inscritos/primeros/modalidades")
	public String inscritosPrimerosModalidades(HttpServletRequest request, Model modelo){
		...
		//enviarConArchivo(request,"Error-aca.ControllerDatosAlumno|credencialEmpDatoDep:");		
		return "inscritos/primeros/modalidades";
	}
}
