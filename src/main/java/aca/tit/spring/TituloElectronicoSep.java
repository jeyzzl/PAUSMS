...
// Generado el: 2019.06.03 a las 03:14:26 PM CDT 
//
...
@XmlRootElement(name = "TituloElectronicoSep")
public class TituloElectronicoSep {

    @XmlElement(name = "FirmaResponsables", required = true)
    protected TituloElectronicoSep.FirmaResponsables firmaResponsables;
    @XmlElement(name = "Institucion", required = true)
    protected TituloElectronicoSep.Institucion institucion;
    @XmlElement(name = "Carrera", required = true)
    protected TituloElectronicoSep.Carrera carrera;
    @XmlElement(name = "Profesionista", required = true)
    protected TituloElectronicoSep.Profesionista profesionista;
    @XmlElement(name = "Expedicion", required = true)
    protected TituloElectronicoSep.Expedicion expedicion;
    @XmlElement(name = "Antecedente", required = true)
    protected TituloElectronicoSep.Antecedente antecedente;
    @XmlElement(name = "Autenticacion")
    protected TituloElectronicoSep.Autenticacion autenticacion;
     ...
     * @return
     *     possible object is
     *     {@link TituloElectronicoSep.FirmaResponsables }
     *     
     */
    public TituloElectronicoSep.FirmaResponsables getFirmaResponsables() {
     ...
     *     
     */
    public void setFirmaResponsables(TituloElectronicoSep.FirmaResponsables value) {
     ...
     * @return
     *     possible object is
     *     {@link TituloElectronicoSep.Institucion }
     *     
     */
    public TituloElectronicoSep.Institucion getInstitucion() {
        return institucion;
    }
     ...
     *     
     */
    public void setInstitucion(TituloElectronicoSep.Institucion value) {
     ...
     * @return
     *     possible object is
     *     {@link TituloElectronicoSep.Carrera }
     *     
     */
    public TituloElectronicoSep.Carrera getCarrera() {
        return carrera;
    }
     ...
     *     
     */
    public void setCarrera(TituloElectronicoSep.Carrera value) {
        this.carrera = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link TituloElectronicoSep.Profesionista }
     *     
     */
    public TituloElectronicoSep.Profesionista getProfesionista() {
     ...
     *     
     */
    public void setProfesionista(TituloElectronicoSep.Profesionista value) {
     ...
     * @return
     *     possible object is
     *     {@link TituloElectronicoSep.Expedicion }
     *     
     */
    public TituloElectronicoSep.Expedicion getExpedicion() {
        return expedicion;
    }
     ...
     *     
     */
    public void setExpedicion(TituloElectronicoSep.Expedicion value) {
     ...
     * @return
     *     possible object is
     *     {@link TituloElectronicoSep.Antecedente }
     *     
     */
    public TituloElectronicoSep.Antecedente getAntecedente() {
        return antecedente;
    }
     ...
     *     
     */
    public void setAntecedente(TituloElectronicoSep.Antecedente value) {
     ...
     * @return
     *     possible object is
     *     {@link TituloElectronicoSep.Autenticacion }
     *     
     */
    public TituloElectronicoSep.Autenticacion getAutenticacion() {
     ...
     *     
     */
    public void setAutenticacion(TituloElectronicoSep.Autenticacion value) {
    ...
    public static class FirmaResponsables {
        ...
        protected List<TituloElectronicoSep.FirmaResponsables.FirmaResponsable> firmaResponsable;
         ...
         * {@link TituloElectronicoSep.FirmaResponsables.FirmaResponsable }
         * 
         * 
         */
        public List<TituloElectronicoSep.FirmaResponsables.FirmaResponsable> getFirmaResponsable() {
            if (firmaResponsable == null) {
                firmaResponsable = new ArrayList<TituloElectronicoSep.FirmaResponsables.FirmaResponsable>();
            }
