...
public class ReligionUtil{
	...
	public boolean insertReg(Connection conn, CatReligion religion ) throws Exception{
		...
		try{
			...
			System.out.println("Error - aca.catalogo.ReligionUtil|insertReg|:"+ex);			
		}finally{
	...
	public boolean updateReg(Connection conn, CatReligion religion ) throws Exception{
		...
		try{
			...
			System.out.println("Error - aca.catalogo.ReligionUtil|updateReg|:"+ex);
		}finally{
			try { ps.close(); } catch (Exception ignore) { }
		}
	...
	public boolean deleteReg(Connection conn, String religionId ) throws Exception{
		...
		try{
			...
			System.out.println("Error - aca.catalogo.ReligionUtil|deleteReg|:"+ex);
		}finally{
			try { ps.close(); } catch (Exception ignore) { }
		}
		return ok;
	...
	public CatReligion mapeaRegId( Connection conn, String religionId) throws SQLException{
		...
		try{
			...
			System.out.println("Error - aca.catalogo.ReligionUtil|mapeaRegId|:"+ex);
			ex.printStackTrace();
		}finally{
	...
	public boolean existeReg(Connection conn, String religionId) throws SQLException{
		...
		try{
			...
			System.out.println("Error - aca.catalogo.ReligionUtil|existeReg|:"+ex);
		}finally{
			try { rs.close(); } catch (Exception ignore) { }
			try { ps.close(); } catch (Exception ignore) { }
		}
	...
	public String maximoReg(Connection conn) throws SQLException{
		...
		try{
			...
			System.out.println("Error - aca.catalogo.ReligionUtil|maximoReg|:"+ex);
		}finally{
			try { rs.close(); } catch (Exception ignore) { }
			try { ps.close(); } catch (Exception ignore) { }
		}
	...
	public static String getNombreReligion(Connection conn, String religionId ) throws SQLException{
		...
		try{
			...
			System.out.println("Error - aca.catalogo.ReligionUtil|getNombreReligion|:"+ex);
		}finally{
			try { rs.close(); } catch (Exception ignore) { }
			try { ps.close(); } catch (Exception ignore) { }
		}
	...
	public static String getNombreCorto(Connection conn, String religionId ) throws SQLException{
		...
		try{
			...
			System.out.println("Error - aca.catalogo.ReligionUtil|getNombreCorto|:"+ex);
		}finally{
			try { rs.close(); } catch (Exception ignore) { }
			try { ps.close(); } catch (Exception ignore) { }
		}
	...
	public ArrayList<CatReligion> getListAll(Connection conn, String orden ) throws SQLException{
		...
		try{
			...
			System.out.println("Error - aca.catalogo.ReligionUtil|getListAll|:"+ex);
		}finally{
			try { rs.close(); } catch (Exception ignore) { }
	...
	public HashMap<String,CatReligion> getMapAll(Connection conn, String orden ) throws SQLException{
		...
		try{
			...
			System.out.println("Error - aca.catalogo.ReligionUtil|getMapAll|:"+ex);
		}finally{
			try { rs.close(); } catch (Exception ignore) { }
			try { st.close(); } catch (Exception ignore) { }
		}
