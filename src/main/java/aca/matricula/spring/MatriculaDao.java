...
public class MatriculaDao{	
	...
	public List<String> InscritosPorCarga(String cargaId, String orden){
		List<String> lista	= new ArrayList<String>();
		
		try{	
//			String comando= "SELECT FACULTAD_ID, CARRERA_ID, SEXO, NACIONALIDAD, RELIGION_ID, MODALIDAD_ID, CLAS_FIN, RESIDENCIA_ID, CRED_ALTA, " +
//					" CRED_BAJA, ESTADO, CODIGO_PERSONAL FROM ENOC.ESTADISTICA WHERE CARGA_ID = ? "+orden;
			String comando= "SELECT FACULTAD_ID||'@'||CARRERA_ID||'@'||SEXO||'@'||NACIONALIDAD||'@'||RELIGION_ID||'@'||MODALIDAD_ID||'@'||CLAS_FIN||'@'||RESIDENCIA_ID||'@'||CRED_ALTA||'@'||" + 
					"CRED_BAJA||'@'||ESTADO||'@'||CODIGO_PERSONAL  FROM ENOC.ESTADISTICA WHERE CARGA_ID = ? "+orden;			
			lista = enocJdbc.queryForList(comando, String.class, cargaId);			
		}catch(Exception ex){
			System.out.println("Error - aca.matricula.spring.matriculaDao|InscritosPorCarga|:"+ex);
		}

		return lista;
	}
	
	public List<String> InscritosPorCargas(String cargaId, String modalidadId,String fechaIni, String fechaFin, String orden){
		List<String> lista = new ArrayList<String>();

		try{	
			String comando	=	"SELECT FACULTAD_ID||'@'||CARRERA_ID||'@'||SEXO||'@'||NACIONALIDAD||'@'||RELIGION_ID||'@'||MODALIDAD_ID||'@'||CLAS_FIN||'@'||RESIDENCIA_ID||'@'||CRED_ALTA||'@'||" + 
					"CRED_BAJA||'@'||CODIGO_PERSONAL FROM ENOC.ESTADISTICA " +
			...
			System.out.println("Error - aca.matricula.spring.matriculaDao|InscritosPorCargas|:"+ex);
		}
...
//	public List<String> getListCursosDisp(String matricula, String carga, String planId, String modalidadId){
//		
...
//			}			
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|getListCursosDisp|:"+ex);
//		}finally{
...
//		public ArrayList<String> getListCursosDispBaja(Connection conn, String matricula, String carga, String planId, String modalidadId){
//			
//			ArrayList<String> lisCursos	= new ArrayList<String>();
//			Statement st 		= conn.createStatement();
//			ResultSet rs 		= null;
...
//				}			
//			}catch(Exception ex){
//				System.out.println("Error - aca.matricula.spring.matriculaDao|getListCursosDispBaja|:"+ex);
//			}finally{
//				try { rs.close(); } catch (Exception ignore) { }
//				try { st.close(); } catch (Exception ignore) { }
//				if (rs2!=null) rs2.close();
...
//	public ArrayList<String> getListCursosDispPorCursoId(Connection conn, String matricula, String carga, String planId, String modalidadId, String cursoId){
//		
//		ArrayList<String> lisCursos	= new ArrayList<String>();
//		Statement st 		= conn.createStatement();
//		ResultSet rs 		= null;
...
//			}			
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|getListCursosDispPorCursoId|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//			if (rs2!=null) rs2.close();
...
//	public ArrayList<String> getListCursosDispAsignados(Connection conn, String matricula, String carga, String planId, String modalidadId, String cursoId){
//		
//		ArrayList<String> lisCursos	= new ArrayList<String>();
//		Statement st 		= conn.createStatement();
//		ResultSet rs 		= null;
...
//			}			
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|getListCursosDispAsignados|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//			if (rs2!=null) rs2.close();
...
//	public ArrayList<String> getListCursos(Connection conn, String matricula, String carga, String planId, String modalidadId){
//		
//		ArrayList<String> lisCursos	= new ArrayList<String>();
//		Statement st 		= conn.createStatement();
//		ResultSet rs 		= null;
...
//			}			
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|getListCursos|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//			if (rs2!=null) rs2.close();
...
//	public ArrayList<String> getListCursosDisp(Connection conn, String matricula,String carga, String planId, String modalidadId, String grupo){
//		
//		ArrayList<String> lisCursos	= new ArrayList<String>();
//		Statement st 		= conn.createStatement();
//		ResultSet rs 		= null;
...
//	}
//	
//	public ArrayList<String> getListCursosMat(Connection conn, String matricula,String carga, String planId, String modalidadId){		
//		ArrayList<String> lisCursos	= new ArrayList<String>();
//		Statement st 		= conn.createStatement();
//		ResultSet rs 		= null;
//		String comando		= "";
...
//			}			
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|getListCursosMat|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//		}
...
//	}
//	
//	public void bajaTotal(Connection conn, String matricula,String carga){		
//		ArrayList<String> lisCursos	= new ArrayList<String>();
//		Statement st 		= conn.createStatement();
//		ResultSet rs 		= null;
//		Statement st2 		= conn.createStatement();
...
//			}			
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|bajaTotal|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }		
//			if (st2!=null) st2.close();
...
//	}
//	
//	public void bajaTotalCoordinador(Connection conn, String matricula,String carga){
//		
//		ArrayList<String> lisCursos	= new ArrayList<String>();
//		Statement st 		= conn.createStatement();
//		ResultSet rs 		= null;
...
//			}			
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|bajaTotalCoordinador|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }		
//			if (st2!=null) st2.close();
...
//	}
//	
//	public boolean preCursosAprobados(Connection conn, String matricula, String planId, String cursoId){
//		
//		boolean OK	= false;
//		Statement st 		= conn.createStatement();
//		ResultSet rs 		= null;
...
//			}
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|preCursosAprobados|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//			if (rs2!=null) rs2.close();
...
//	}
//	
//	public String preCursoFalta(Connection conn, String matricula, String cursoId){
//				
//		Statement st 		= conn.createStatement();
//		ResultSet rs 		= null;
//		String comando		= "";
...
//			}
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|preCursoFalta|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//		}
...
//	}
//	
//	public int totalInscritos(Connection conn, String cargaId){
//		int total=0;
//		Statement st 		= conn.createStatement();
//		ResultSet rs 		= null;
//		String comando	= "";
...
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|totalInscritos|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//		}
//		return total;
//	}
//	public int totalInscritosFac(Connection conn, String cargaId,String facultadId){
//		int total=0;
//		Statement st 		= conn.createStatement();
//		ResultSet rs 		= null;
//		String comando	= "";
...
//				total = rs.getInt("total");
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|totalInscritosFac|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//		}
...
//	}
//	
//	public int totalCCobro(Connection conn, String cargaId){
//		int total=0;
//		Statement st 		= conn.createStatement();
//		ResultSet rs 		= null;
//		String comando	= "";
...
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|totalCCObro|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//		}
//		return total;
//	}
//	public int totalCCobroFac(Connection conn, String cargaId, String facultadId){
//		int total=0;
//		Statement st 		= conn.createStatement();
//		ResultSet rs 		= null;
//		String comando	= "";
...
//				total = rs.getInt("num_cobros");
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|totalCCobroFac|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//		}
...
//	}
//	
//	public int totalCarga(Connection conn, String cargaId){
//		int total=0;
//		Statement st 		= conn.createStatement();
//		ResultSet rs 		= null;
//		String comando	= "";
...
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|totalCarga|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//		}
//		return total;
//	}	
//	public int totalCargaFac(Connection conn, String cargaId, String facultadId){
//		int total=0;
//		Statement st 		= conn.createStatement();
//		ResultSet rs 		= null;
//		String comando	= "";
...
//				total = rs.getInt("num_cargas");
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|totalCargaFac|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//		}
...
//	}	
//	
//	public int[] estadistica(Connection conn, String cargaId){
...
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|estadistica|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			if (rs2!=null) rs2.close();
//			try { st.close(); } catch (Exception ignore) { }
...
//		return ret;
//	}	
//	public int[] facultadEstadistica(Connection conn, String cargaId, String facultadId){
//		int ret[] = {0,0,0,0,0,0,0,0,0};
//		Statement st 		= conn.createStatement();
//		ResultSet rs 		= null;
//		ResultSet rs2 		= null;
...
//			}	
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|facultadEstadistica|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//		}
//		return ret;
//	}	
//	public ArrayList<String> estadisticaFac(Connection conn, String cargaId){
...
//			}
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|estadisticaFac|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//		}
//		return lisFac;
//	}		
//	public ArrayList<String> estadisticabFac(String cargaId){
//		ArrayList<String> lisFac	= new ArrayList<String>();
//		Statement st 		= Conn.createStatement();
//		ResultSet rs 		= null;
//		String comando	= "", cadena="";
...
//	}
//	
//	public String bajasCarrera(String cargaId, String carreraId){
//		
//		Statement st 		= Conn.createStatement();
//		ResultSet rs 		= null;
...
//			}
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|bajasCarrera|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//		}
...
//	}
//	
//	public ArrayList<String> estadisticaCarr(String cargaId){
//		ArrayList<String> lisFac	= new ArrayList<String>();
//		Statement st 		= Conn.createStatement();
//		ResultSet rs 		= null;
...
//			}
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|estadisticaCarr|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//		}
//		return lisFac;
//	}			
//	public ArrayList<String> estadisticaCarrera(String cargaId, String facultadId){
//		ArrayList<String> lisFac	= new ArrayList<String>();
//		Statement st 		= Conn.createStatement();
//		ResultSet rs 		= null;
//		String comando	= "", cadena="";
...
//			}
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|estadisticaCarrera|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//		}
...
//	}			
//	
//	public int[] estadisticaCarrDetalle(String cargaId, String s_carrera_id){
//		int ret[]= new int[14];
//		Statement st 		= Conn.createStatement();
//		ResultSet rs 		= null;
//		ResultSet rs2 		= null;
...
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|estadisticaCarrDetalle|:"+ex);
//		}finally{
//			if (rs2!=null) rs2.close();
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }			
...
//		return ret;
//	}	
//	public int[] estadisticaCarrDetalle2(String cargaId, String s_carrera_id){
//		int ret[] = new int[12];
//		Statement st 		= Conn.createStatement();
//		ResultSet rs 		= null;
//		String comando	= "";
...
//		}catch(Exception ex){
//			System.out.println("Error - aca.matricula.spring.matriculaDao|estadisticaCarrDetalle2|:"+ex);
//		}finally{
//			try { rs.close(); } catch (Exception ignore) { }
//			try { st.close(); } catch (Exception ignore) { }
//		}
...
//	
//	
//	public int getCreditosVendidosxFacultad(Connection conn,String carga,String facultad){
//	    int creditos=0;
...
//	}
//
//	public int getCreditosVendidosxCarrera(Connection conn,String carga,String carrera){
//	    int creditos=0;
//	    PreparedStatement ps =null;
//	    ResultSet rs=null;
//	    
...
//	}
//	
//	public int getInscritosxCarrera(Connection conn,String carga,String carrera){
//	    int inscritos=0;
//	    PreparedStatement ps =null;
//	    ResultSet rs=null;	    
//	    try {
...
//	public String revisarChoqueDeHorarioPorAlumnoMateria(Connection conn, String codigoPersonal, String cargaId, String cursoCargaIdElegida, String bloqueId){
