...
<div class="container-fluid">
	<h1>Elegir Modalidades</h1>
	<form id="forma" name="forma" action="modalidades" method="post">
	<input name="Accion" type="hidden">
	<div class="alert alert-info">
		<a class="btn btn-primary btn-small" href="reporte"><i class="fas fa-arrow-left"></i></a>&nbsp;
	...
	<thead class="table-info">
		<tr>
			<th width="15%">Elegir
				<a onclick="jQuery('.checkboxModalidad').prop('checked', true)" class="btn btn-light"><spring:message code='aca.Todos'/></a>&nbsp;
				<a onclick="jQuery('.checkboxModalidad').prop('checked', false)" class="btn btn-light"><spring:message code='aca.Ninguno'/></a>	
			</th>
			<th width="15%"><spring:message code="aca.Clave"/></th>
			<th width="70%"><spring:message code="aca.Modalidad"/></th>
		</tr>	
	</thead>
