...
<div class="container-fluid">
	...
	<thead class="table-info">
		<tr>
			<th width="20%">Elegir
				<a onclick="jQuery('.checkboxModalidad').prop('checked',true)" class="btn btn-info"><spring:message code='aca.Todos'/></a>&nbsp;
				<a onclick="jQuery('.checkboxModalidad').prop('checked', false)" class="btn btn-info"><spring:message code='aca.Ninguno'/></a>	
			</th>
