...
<%  
        ...
        for(FinQuoteConcept quoteConcept : lisQuoteConcepts){
            ...
            if(concept.getType().equals("F") || concept.getType().equals("S")) totalFees += quoteConcept.getAmount();
            if(concept.getType().equals("D")) totalDisc += quoteConcept.getAmount();
...
%>
            <tr>
                ...
                <td><%=currencyFormat.format(concept.getUnitCost())%></td>
                <td><%=quoteConcept.getNoUnits()%></td>
                <td><%=quoteConcept.getAmount()%></td>
            </tr>
<%      }
...
%>
    ...
    <div class="alert alert-warning align-items-center d-flex justify-content-end">
        <h3 class="me-3">Total Fees:</h3>
        <h5><%=currencyFormat.format(totalFees)%></h5>
    </div>
    <div class="alert alert-success align-items-center d-flex justify-content-end">
        <h3 class="me-3">Total Discounts:</h3>
        <h5><%=currencyFormat.format(totalDisc)%></h5>
    </div>
