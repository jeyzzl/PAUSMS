...
<head>
	<script type="text/javascript">
		function cambioPeriodo(){
			...
			location.href = "nuevoExterno?PeriodoId="+periodoId;
		}
	</script>
</head>
...
<% 				for(ResPeriodo periodo : lisPeriodo){%>
					<option <%=alumno.getPeriodoId().equals(periodo.getPeriodoId()) ? "selected" : ""%> value="<%=periodo.getPeriodoId()%>"><%=periodo.getPeriodoNombre()%></option>	
<% 				}%>
				</select>
			</div>
			<div class="col-sm-3">
