...
<% 		}%>
	...
	<tr>
    	...
    	<th width="7%" class="text-center">F.Vigencia</th>
    	...
    	<th width="7%" class="text-center">Documentos</th>
    	<th width="3%" class="text-center">Ver</th>  		  
	</tr>
	</thead>
	<tbody>
<%	
...
<%  	 }%>
    	...
    	<% if(mapa.containsKey(convenio.getId()+"1")){%>
    		<a href="descargaImagen?IdConvenio=<%=convenio.getId()%>&Folio=1"><span class="badge bg-success rounded-pill">1</span></a>&nbsp;
    	<% }else{%>    		
    	<% }%>    		
    	 <% if(mapa.containsKey(convenio.getId()+"2")){%>
    		<a href="descargaImagen?IdConvenio=<%=convenio.getId()%>&Folio=2"><span class="badge bg-success rounded-pill">2</span></a>&nbsp;
    	<% }else{%>    		
    	<% } %>    		
    	<% if(mapa.containsKey(convenio.getId()+"3")){%>
    		<a href="descargaImagen?IdConvenio=<%=convenio.getId()%>&Folio=3"><span class="badge bg-success rounded-pill">3</span></a>&nbsp;
    	<% }else{%>
    	<% }%></td>
    	<td class="text-center"> 
    	<% if(mapa.containsKey(convenio.getId()+"1")){%>
