	...
	(function($){
		...
		$('.crear-respaldo').on('click', function(e){
			...
			*/
			...
			$.get('zipMaestros?fechaIni='+fInicio.val()+'&fechaFin='+fFin.val(), function(r){
		...
		$('.eliminar-respaldo').on('click', function(e){
			...
			$.get('deleteZipMaestros', function(r){
