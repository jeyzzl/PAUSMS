	...
	(function($){
		...
		$('.crear-respaldo').on('click', function(e){
			...
			*/
			...
			$.get('zipadmarchivos?fechaIni='+fInicio.val()+'&fechaFin='+fFin.val(), function(r){
		...
		$('.eliminar-respaldo').on('click', function(e){
			...
			$.get('deleteZipAdmArchivos', function(r){
