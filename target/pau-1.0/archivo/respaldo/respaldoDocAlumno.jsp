	...
	(function($){
		...
		$('.crear-respaldo').on('click', function(e){
			...
			*/
			...
			$.get('zipDocAlumno?fechaIni='+fInicio.val()+'&fechaFin='+fFin.val(), function(r){
		...
		$('.eliminar-respaldo').on('click', function(e){
			...
			$.get('deleteZipDocAlumno', function(r){
