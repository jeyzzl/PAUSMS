...
<%
	...
	try{
		 ...
		 COMANDO = "select count(*) as total from arch_general where fecha between to_date('"+fechaIni+"', 'DD/MM/YYYY') and to_date('"+fechaFin+"', 'DD/MM/YYYY')";
	...
	try{ 
		...
		String zipFile = dir+"resGen.zip";
		FileOutputStream fout	= new FileOutputStream(zipFile);
		ZipOutputStream zout	= new ZipOutputStream(new BufferedOutputStream(fout));
		
		while (rset2.next()){				
			String NombreArch 		= rset2.getString("matricula")+"-"+rset2.getString("folio")+".jpg";			
	...
	if(error){
		...
		new File(dir+"resGen.zip").delete();
	}
