...
<%
	...
	try{
		 ...
		 COMANDO = "select * from adm_archivos";
		 rset2 = stmt2.executeQuery(COMANDO);
	...
	try{ 
		...
		String zipFile = dir+"admArchivos.zip";
		...
		while (rset2.next()){
			...
			String NombreArch 		= rset2.getString("folio")+"-"+rset2.getString("documento_id")+"."+ext;
	...
	if(error){
		...
		new File(dir+"admArchivos.zip").delete();
	}
