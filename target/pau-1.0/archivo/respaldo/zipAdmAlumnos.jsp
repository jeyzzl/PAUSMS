...
<%
	...
	try{
		 ...
		 COMANDO = "select * from adm_docalum";
		 rset2 = stmt2.executeQuery(COMANDO);
	...
	try{ 
		...
		String zipFile = dir+"admDocAlum.zip";
		FileOutputStream fout	= new FileOutputStream(zipFile);
		ZipOutputStream zout	= new ZipOutputStream(new BufferedOutputStream(fout));
		
		while (rset2.next()){
			
			String NombreArch 		= rset2.getString("folio")+"-"+rset2.getString("documento_id")+"-"+rset2.getString("hoja")+".jpg";
