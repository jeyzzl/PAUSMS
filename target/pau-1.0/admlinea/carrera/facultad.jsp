...
<jsp:useBean id="FacultadUtil"  class="aca.catalogo.FacultadUtil" scope="page"/>
<%  
...
%>
	<tr>
		...
		<td align="left"><a href="modalidades?FacultadId=<%=facultad.getFacultadId()%>"><font size="2"><%=facultad.getNombreFacultad()%></font></a></td>
