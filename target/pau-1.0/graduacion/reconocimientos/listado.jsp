...
<div class="container-fluid">
	<h2>Alumnos graduados reconocimiento</h2>
	<form name="forma" method="post" action="listado">
	<div class="alert alert-info d-flex align-items-center">
		Fecha Inicio:&nbsp;
		<input id="fechaInicio" name="fechaInicio" class="form-control" placeholder="Fecha Inicio" data-date-format="dd/mm/yyyy" value="<%=fechaInicio%>" style="width:120px;">
			&nbsp;&nbsp;&nbsp;
			Fecha Final:&nbsp;
			<input id="fechaFinal" name="fechaFinal" class="form-control" placeholder="Fecha Final" data-date-format="dd/mm/yyyy" value="<%=fechaFinal%>" style="width:120px;">
			&nbsp;
			<a href="javascript:Filtrar();" class="btn btn-primary">Buscar</a>
	</div>
	</form>
