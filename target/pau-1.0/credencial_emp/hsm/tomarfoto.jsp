...
<%
	...
	alumno = AlumUtil.mapeaRegId(conEnoc,clave);
%>
<head>
	...
	<script type="text/javascript">
        webcam.set_api_url( 'upload.jsp?CodigoEmpleado=<%=clave%>' );
		...
		function my_completion_handler(msg) {
			...
			'<br><img height=340 src=../../foto?Codigo=<%=clave%>&Tipo=O&hola='+encodeURIComponent(new Date())+'>';
        ...
        <tr>
          <td align="center">
      		<div id="resultado" style="margin-top:1em;-moz-border-radius:12px; background-color:#ddd;width:360px;text-align:center;height:500px;padding-top:15px;margin-bottom:1em;">
      		  ...
      		  <img height="340" src="../../foto?Codigo=<%=clave%>&Tipo=O">
      		</div>
      	  </td>
      	</tr>
      	<tr>
    	  <td align="center"><a href="empleado.jsp?CodigoEmpleado=<%=clave%>" style="font-size:11pt;">&lsaquo;&lsaquo; <spring:message code="aca.Regresar"/></a></td>
	  	</tr>
     </table> 	  	
    </td>
  </tr>    
