...
<div class="container-fluid">
	...
	<div class="alert alert-info">
		<a class="btn btn-primary" href="calculo"><spring:message code="aca.Regresar"/></a> 
	</div>
...
%>				
	<tr <%=sBgcolor%>> 
	    ...
	    <td>
		  <a href="calculo?Codigo=<%=alumno.getCodigoId()%>">
...
<%  
			...
			if (lisAlumno.size()==1){			
				response.sendRedirect("calculo?Codigo="+alumno.getCodigoId());
			}	
			break;
		} 
		case 2:{
