...
<div class="container-fluid">
	...
	<form action="" method="post" name="accion_meta">
	    ...
	    <input name="TKL_id_meta" type="hidden" id="TKL_id_meta" value="<%= request.getParameter("TKL_id_meta")%>">
