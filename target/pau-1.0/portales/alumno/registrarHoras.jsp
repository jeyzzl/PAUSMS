...
<%  if(trabInformeAlum.getStatus().equals("A")){%>
        ...
        <textarea class="form-control mb-4" id="Descripcion" name="Descripcion" rows="3" style="width: 25rem;"><%=trabInformeAlum.getDescripcion()==null?"":trabInformeAlum.getDescripcion()%></textarea>
