...
<%-- 		<th><spring:message code="mapa.plan.PlanSE"/></th> --%>
		...
		<th><spring:message code="aca.Precio"/></th>
	  </tr>
    </thead>
	<tbody>
<%
...
<%-- 	    <td align="center"><%=mplan.getPlanSE()%></td> --%>
	    ...
	    <td align="center"><%=mplan.getPrecio().equals("S")?"<span class='badge bg-dark rounded-pill'>YES</span>":"<span class='badge bg-secondary rounded-pill'>NO</span>"%></td>
	  </tr>
<%
		fRevoe			= "-";
		fRetro			= "-";
