...
<div class="container-fluid">
	<h2><spring:message code="mapa.plan.PlanesEstudio"/> Catalog<small class="text-muted fs-4"> (School List)</small></h2>
	<hr>
...
%>
		<tr>
			...
			<td class="text-start"><a href="plan?Facultad=<%=facultad.getFacultadId()%>"><%=facultad.getNombreFacultad()%></a></td>
