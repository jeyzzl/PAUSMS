...
<%
	...
	List<MapaNuevoUnidad> listUnidades 					= (List<MapaNuevoUnidad>)request.getAttribute("listUnidades");
	...
	try{ 
            ...
            public void onEndPage(PdfWriter writer, Document document) {
            	if(writer.getPageNumber() > 0){
	        		...
	        		try{
	        	        ...
	        	        PdfPCell footerCell = new PdfPCell(new Phrase(mapaNuevoPlan.getNombre()+" - version "+mapaNuevoPlan.getYear()+" - "+mapaNuevoCurso.getNombre(),
        ...
        document.open();
    		...
    		if(mapaNuevoPlan.getHts().equals("S")){
				celda = new PdfPCell(new Phrase("HTS:", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
				celda.setHorizontalAlignment(Element.ALIGN_LEFT);
				celda.setBorder(Rectangle.RECTANGLE);
    		...
    		if(mapaNuevoPlan.getHps().equals("S")){
				celda = new PdfPCell(new Phrase("HPS:", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
				celda.setHorizontalAlignment(Element.ALIGN_LEFT);
				celda.setBorder(Rectangle.RECTANGLE);
				horasCreditos.addCell(celda);
    		...
    		if(mapaNuevoPlan.getHfd().equals("S")){
				celda = new PdfPCell(new Phrase("HFD:", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
				celda.setHorizontalAlignment(Element.ALIGN_LEFT);
				celda.setBorder(Rectangle.RECTANGLE);
				horasCreditos.addCell(celda);
    		...
    		if(mapaNuevoPlan.getHei().equals("S")){
	    		celda = new PdfPCell(new Phrase("HEI:", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
				celda.setHorizontalAlignment(Element.ALIGN_CENTER);
				celda.setBorder(Rectangle.RECTANGLE);
				horasCreditos.addCell(celda);
    		...
    		if(mapaNuevoPlan.getHss().equals("S")){
	    		celda = new PdfPCell(new Phrase("HSS:", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
				celda.setHorizontalAlignment(Element.ALIGN_CENTER);
				celda.setBorder(Rectangle.RECTANGLE);
				horasCreditos.addCell(celda);
    		...
    		if(mapaNuevoPlan.getHas().equals("S")){
	    		celda = new PdfPCell(new Phrase("HAS:", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
				celda.setHorizontalAlignment(Element.ALIGN_CENTER);
				celda.setBorder(Rectangle.RECTANGLE);
				horasCreditos.addCell(celda);
    		...
    		celda = new PdfPCell(new Phrase("THS:", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_CENTER);
			celda.setBorder(Rectangle.RECTANGLE);
			horasCreditos.addCell(celda);
			...
			celda = new PdfPCell(new Phrase("CRS:", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_CENTER);
			celda.setBorder(Rectangle.RECTANGLE);
			horasCreditos.addCell(celda);
			...
			celda = new PdfPCell(new Phrase("HORAS TOTALES:", FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_LEFT);
			celda.setColspan(2);
			celda.setBorder(Rectangle.RECTANGLE);
			cabeceraCurso.addCell(celda);
			...
			for(MapaNuevoUnidad mapaNuevoUnidad : listUnidades){
