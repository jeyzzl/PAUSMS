...
<% }%>
	<form action="grabarBecSolicitud" name="form" method="post">
		...
		<div style="padding-left:15px;" class="form-group row">
			<div class="col-md-3">
				<label>Porcentaje coordinador</label>
				<input class="form-control" type="text" name="PorCoordinador" value="<%=becSolicitud.getPorCoordinador()%>">
			</div>
			<div class="col-md-12"><br>
				<label>Comentario</label>
				<textarea class="form-control" rows="" cols="" name="Comentario" maxlength="500"><%=becSolicitud.getComCoordinador()%></textarea>
			</div>
		</div><br>
