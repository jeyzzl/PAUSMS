...
<div class="container-fluid">
	...
	<h4>Número de Alumnos: <span class='badge badge bg-inverse'><%=numAlumnos%></span> &nbsp; &nbsp; Puntos evaluados: <span class='badge badge bg-inverse'><%=avanceMateria%></span></h4>	
	<br>
...
<%	int row = 0;
	for (CargaGrupoEvaluacion evaluacion : lisEvaluaciones){
		...
		String badge = "badge bg-inverse";
		
		if( Float.valueOf(notasEvaluaciones) >= Float.valueOf(numEvaluaciones)/2 ){
			badge = "badge bg-info";
		}

		if(!aca.util.Fecha.getFechaMayorQueHoy(evaluacion.getFecha())){
			if(Float.valueOf(notasEvaluaciones) < Float.valueOf(numEvaluaciones)/2){
...
%>	
		<tr class="alert alert-success">
			...
			<td><h5><%=evaluacion.getEstrategiaId()%> - <%=evaluacion.getNombreEvaluacion()%></h5></h5></td>			
