...
$.TextboxListBit = function(type, value, textboxlist, _options){
	...
	var init = function(){
		...
		if (type == 'box'){
			...
			element = $('<input type="text" style="font-size:1.2em;height:20px;margin:0;padding:4px 0;line-height:0;border-color:transparent;-webkit-box-shadow:inset 0 0px 0px rgba(0, 0, 0, 0.075),0 0 0px rgba(82, 168, 236, 0.6);-moz-box-shadow:inset 0 0px 0px rgba(0, 0, 0, 0.075),0 0 0px rgba(82, 168, 236, 0.6);box-shadow:inset 0 0px 0px rgba(0, 0, 0, 0.075),0 0 0px rgba(82, 168, 236, 0.6);outline:0;letter-spacing:0;" class="'+ typeprefix +'-input" autocomplete="off" />').val(self.value ? self.value[1] : '').appendTo(bit);
