...
<div class="container-fluid">
	<h2><spring:message code="cargasGrupo.grupo.HorarioSalones"/><small class="text-muted fs-5">( <%=cargaId%> - <%=cargaNombre%> - <%=planId%> )</small></h2>
...
%>		</select>
	...
	<table style="width:100%; margin: 0 auto;"  class="table table-bordered">
		<tr height="30px">
			...
			<th width="11%"><h4><spring:message code="aca.Hora"/></h4></th>
