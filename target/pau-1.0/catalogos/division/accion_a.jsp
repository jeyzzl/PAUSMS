...
<jsp:useBean id="AsociacionUtil" scope="page" class="aca.catalogo.AsociacionUtil"/>
...
<script type="text/javascript">
	...
	function Nuevo()	{	
		...
		document.frmasociacion.PaisId.value 			= "0";
		document.frmasociacion.EstadoId.value 			= "0";
		document.frmasociacion.CiudadId.value 			= "0";
...
<%
	...
	if ( nAccion == 1 ){
		Asociacion.setAsociacionId(AsociacionUtil.maximoReg(conEnoc, Asociacion.getDivisionId(), Asociacion.getUnionId()));
	}else{
	...
	switch (nAccion){
		...
		case 2: { // Grabar			
			...
			Asociacion.setCiudadId(request.getParameter("CiudadId"));
				if (AsociacionUtil.existeReg(conEnoc, request.getParameter("DivisionId"), request.getParameter("UnionId"), Asociacion.getAsociacionId()) == false){
					if (AsociacionUtil.insertReg(conEnoc, Asociacion )){
		...
		case 3: { // Modificar			
			Asociacion.setEstadoId(request.getParameter("EstadoId"));
			Asociacion.setCiudadId(request.getParameter("CiudadId"));
			if (AsociacionUtil.existeReg(conEnoc, request.getParameter("DivisionId"), request.getParameter("UnionId"), Asociacion.getAsociacionId()) == true){
				if (AsociacionUtil.updateReg(conEnoc, Asociacion)){
		...
		case 4: { // Borrar
			if (AsociacionUtil.existeReg(conEnoc, request.getParameter("DivisionId"), request.getParameter("UnionId"), Asociacion.getAsociacionId()) == true){
				if (AsociacionUtil.deleteReg(conEnoc, Asociacion.getDivisionId(), Asociacion.getUnionId(), Asociacion.getAsociacionId())){
		...
		case 5: { // Consultar			
				if (AsociacionUtil.existeReg(conEnoc, request.getParameter("DivisionId"), request.getParameter("UnionId"), Asociacion.getAsociacionId()) == true){
				AsociacionUtil.mapeaRegId(conEnoc, request.getParameter("DivisionId"), request.getParameter("UnionId"), Asociacion.getAsociacionId());
				sResultado = "Consulta";
			}else{
				sResultado = "No existe: "+Asociacion.getAsociacionId(); 
			}	
...
<h1>Catalogo de Asociaciones</h1>
<div class="alert alert-info">
	<a class="btn btn-primary" href="asociacion?DivisionId=<%=Asociacion.getDivisionId()%>&UnionId=<%=Asociacion.getUnionId()%>"><i class="fas fa-arrow-left"></i></a>
</div>
      ...
      <td> 
        <table class="table table-sm table-bordered">   
          <tr> 
            <td width="30%"><strong><spring:message code="aca.Clave"/>:</strong></td>
             <td width="76%"><input type="hidden" name="DivisionId" value="<%=Asociacion.getDivisionId()%>">
              ...
              <input name="AsociacionId" type="text" class="form-control" size="3" maxlength="3" value="<%=Asociacion.getAsociacionId()%>"></td>
          </tr>
          <tr> 
            <td><strong><spring:message code="aca.Nombre"/>:</strong></td>
            <td><input name="NombreAsociacion" type="text" class="form-control" id="NombreAsociacion" value="<%=Asociacion.getNombreAsociacion()%>" size="40" maxlength="40"></td>
		  </tr>
		   <tr> 
            <td><strong>Direccion:</strong></td>
            <td><input name="Direccion" type="text" class="form-control" id="Direccion" value="<%=Asociacion.getDireccion()%>" size="40" maxlength="40"></td>
		  </tr>
		   <tr> 
            <td><strong>Colonia:</strong></td>
            <td><input name="Colonia" type="text" class="form-control" id="Colonia" value="<%=Asociacion.getColonia()%>" size="40" maxlength="40"></td>
		  </tr>
		   <tr> 
            <td><strong>CodPostal:</strong></td>
            <td><input name="CodPostal" type="text" class="form-control" id="gCodPostal" value="<%=Asociacion.getCodPostal()%>" size="40" maxlength="40"></td>
		  </tr>
		   <tr> 
            <td><strong><spring:message code='aca.Telefono'/>:</strong></td>
            <td><input name="Telefono" type="text" class="form-control" id="Telefono" value="<%=Asociacion.getTelefono()%>" size="40" maxlength="40"></td>
		  </tr>
		   <tr> 
            <td><strong>Fax:</strong></td>
            <td><input name="Fax" type="text" class="form-control" id="Fax" value="<%=Asociacion.getFax()%>" size="40" maxlength="40"></td>
		  </tr>
		   <tr> 
            <td><strong>Email:</strong></td>
            <td><input name="Email" type="text" class="form-control" id="Email" value="<%=Asociacion.getEmail()%>" size="40" maxlength="40"></td>
		  </tr>
		   <tr> 
            <td><strong>Pais:</strong></td>
            <td><select name="PaisId" id="PaisId" onchange = "PEC('1')" class="form-select">
                <%			  	
		   ...
		   <tr> 
            ...
            <td><select name="EstadoId" id="EstadoId" onChange= "javascript:PEC('2')" class="form-select">
                <%			  	
		  ...
		  <tr> 
            ...
            <td><select name="select" id="select2" class="form-select">
                <%			  	
		  ...
		  <tr> 
            <th colspan="2" align="center"> <a class="btn btn-primary" href="javascript:Nuevo()"><spring:message code='aca.Nuevo'/></a> 
			  &nbsp;<a class="btn btn-success" href="javascript:Grabar()"><spring:message code="aca.Grabar"/></a> &nbsp; <a class="btn btn-primary" href="javascript:Modificar()"><spring:message code='aca.Modificar'/></a> 
              &nbsp; <a class="btn btn-danger" href="javascript:Borrar()"><spring:message code='aca.Borrar'/></a> &nbsp; <a class="btn btn-danger" href="javascript:Consultar()"><spring:message code='aca.Consultar'/></a> 
            </th>
          </tr>
        </table>
	</td>
