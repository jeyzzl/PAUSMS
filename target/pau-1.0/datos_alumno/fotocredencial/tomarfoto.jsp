...
<div class="container-fluid">
	<h2>Tomar Foto <small class="text-muted fs-6">( <%=alumno.getCodigoPersonal() %> - <%=nombreAlumno %> )</small></h2>
	<hr>	
    <div class="row">
	...
	<input type="hidden" id="matricula" name="matricula" value="<%=alumno.getCodigoPersonal()%>">
